...
public class HostsConfigHolder extends AbstractHolder
{
	...
	private final TIntObjectMap<HostInfo> _gameServerHosts;

	public HostsConfigHolder()
	{
		_gameServerHosts = new TIntObjectHashMap<>();
	}
