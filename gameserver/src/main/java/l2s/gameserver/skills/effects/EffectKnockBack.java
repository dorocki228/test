...
public class EffectKnockBack extends EffectFlyAbstract
{
	...
	public EffectKnockBack(Creature creature, Creature target, Skill skill, boolean reflected, EffectTemplate template)
	{
	...
	public void onStart()
	{
		...
		getEffected().broadcastPacket(new FlyToLocationPacket(getEffected(), new Location(_x, _y, _z), FlyToLocationPacket.FlyType.PUSH_HORIZONTAL, getFlySpeed(), getFlyDelay(), getFlyAnimationSpeed()));
