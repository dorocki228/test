...
public class i_get_sp extends i_abstract_effect
{
	private final long _power;
	private final int _percentPower;
	private final int _percentPowerMaxLvl;

	public i_get_sp(Creature creature, Creature target, Skill skill, boolean reflected, EffectTemplate template)
	{
