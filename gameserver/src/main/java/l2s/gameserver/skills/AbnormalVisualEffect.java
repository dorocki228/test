...
public enum AbnormalVisualEffect
{
	...
	/*78*/NGRADE_CHANGE, // Переодевает в NG.
	/*79*/DGRADE_CHANGE, // Переодевает в D.
	/*80*/CGRADE_CHANGE, // Переодевает в C.
	/*81*/BGRADE_CHANGE, // Переодевает в B.
	/*82*/AGRADE_CHANGE, // Переодевает в A.
	...
	SHADOW_MASTER_STANDARD(10138),
	SHADOW_MASTER_LEGENDARY(10139),
	SHADOW_MASTER_MYTHIC(10140),
	ADMIRAL_NAVY_STANDARD(10141),
	ADMIRAL_NAVY_LEGENDARY(10142),
	ADMIRAL_NAVY_MYTHIC(10143),
	SKELETON_STANDARD(10144),	// unknown
	SKELETON_LEGENDARY(10145), //unknown
	SKELETON_MYTHIC(10146), //unknown
	FUCKING_GAY_STANDARD(10147), 	//unknown
	FUCKING_GAY_LEGENDARY(10148), //unknown
	FUCKING_GAY_MYTHIC(10149), //unknown
	DEVIL_STANDARD(10150),
	DEVIL_LEGENDARY(10151),
	DEVIL_MYTHIC(10152),
	PIC_1_STANDARD(10153), //unknown
	PIC_1_LEGENDARY(10154), //unknown
	PIC_1_MYTHIC(10155), //unknown
	NYMPH_STANDARD(10156),
	NYMPH_LEGENDARY(10157),
	NYMPH_MYTHIC(10158),
	PIC_2_STANDARD(10159), //unknown
	PIC_2_LEGENDARY(10159), //unknown
	PIC_2_MYTHIC(10160); //unknown

	public static final AbnormalVisualEffect[] VALUES = values();

	public static AbnormalVisualEffect valueOf(int abnormalId) {
		for(AbnormalVisualEffect abnormalVisualEffect : VALUES) {
			if(abnormalVisualEffect.getId() == abnormalId)
				return abnormalVisualEffect;
		}
		return null;
	}

	public static AbnormalVisualEffect find(String name) {
		return AbnormalVisualEffect.valueOf(name.replace("ave_", "").toUpperCase());
	}
