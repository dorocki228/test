...
public class PetFeed extends Skill
{
	...
	{
		return super.checkCondition(activeChar, target, forceUse, dontMove, first) && (target.isPet() || target.isPlayer() && target.getPlayer().isMounted());
	}
