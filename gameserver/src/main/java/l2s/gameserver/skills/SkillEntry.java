...
public class SkillEntry
{
	...
	public final boolean checkCondition(Creature activeChar, Creature target, boolean forceUse, boolean dontMove, boolean first, boolean sendMsg, TriggerType triggerType)
	{
		return _skill.checkCondition(activeChar, target, forceUse, dontMove, first, sendMsg, triggerType);
	}
	...
	public final SystemMsg checkTarget(Creature activeChar, Creature target, Creature aimingTarget, boolean forceUse, boolean first, TriggerType triggerType)
	{
		return _skill.checkTarget(activeChar, target, aimingTarget, forceUse, first, triggerType);
	}
