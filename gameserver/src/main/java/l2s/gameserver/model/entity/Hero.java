...
public class Hero
{
	...
	private void init()
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Hero System: Couldnt load Heroes" );
		}
		finally
		{
		...
		_log.atInfo().log( "Hero System: Loaded %s Heroes.", lazy(() -> _heroes.size()) );
		_log.atInfo().log( "Hero System: Loaded %s all time Heroes.", lazy(() -> _completeHeroes.size()) );
	}
	...
	public void updateHeroes(int id)
	{
		...
		{
			_log.atWarning().log( "Hero System: Couldnt update Heroes" );
	...
	public void loadDiary(int charId)
	{
		...
		try
		{
			...
			if(Config.DEBUG)
				_log.atInfo().log( "Hero System: Loaded %s diary entries for Hero(object id: #%s)", lazy(() -> diary.size()), charId );
		}
		catch(SQLException e)
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Hero System: Couldnt load Hero Diary for CharId: %s", charId );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement, rset);
	...
	private void insertHeroDiary(int charId, int action, int param)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SQL exception while saving DiaryData." );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
	...
	public void loadMessage(int charId)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Hero System: Couldnt load Hero Message for CharId: %s", charId );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement, rset);
	...
	public void saveHeroMessage(int charId)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SQL exception while saving HeroMessage." );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
