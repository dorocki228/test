...
public class Reflection
{
	...
	public int getVariable(String str, int val)
	{
		return _variables.getInteger(str, val);
	}

	public long getVariable(String str, long val)
	{
		return _variables.getLong(str, val);
	}

	public boolean getVariable(String str, boolean val)
	{
		return _variables.getBool(str, val);
	}

	public String getVariable(String str, String val)
	{
		return _variables.getString(str, val);
	}
