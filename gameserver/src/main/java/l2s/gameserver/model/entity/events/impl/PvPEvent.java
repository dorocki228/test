...
public class PvPEvent extends SingleMatchEvent
{
	...
	public void abnormals(Player player, boolean start)
	{
		...
		List<AbnormalVisualEffect> abnormalVisualEffects = getObjects("abnormal" + teamId);
		for(AbnormalVisualEffect abnormalVisualEffect : abnormalVisualEffects)
		{
			if(start)
				player.startAbnormalEffect(abnormalVisualEffect);
			else
				player.stopAbnormalEffect(abnormalVisualEffect);
		}
	}
	...
	@Override
	public boolean canUseCommunityFunctions(Player player, CommunityFunctionType functionType)
	{
		return functionType == CommunityFunctionType.BUFFER;
	}
