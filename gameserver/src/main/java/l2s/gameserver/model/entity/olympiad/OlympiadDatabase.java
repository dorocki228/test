...
public class OlympiadDatabase
{
	...
	public static synchronized void loadParticipantsRank()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Olympiad System: Error!" );
		}
		finally
		{
	...
	{
		_log.atInfo().log( "Olympiad: Calculating last period..." );
		Connection con = null;
		PreparedStatement statement = null;
		try
		{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Olympiad System: Couldn't calculate last period!" );
		}
		finally
		{
	...
	public static synchronized List<StatsSet> computeHeroesToBe()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Olympiad System: Couldnt heros from db!" );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement, rset);
