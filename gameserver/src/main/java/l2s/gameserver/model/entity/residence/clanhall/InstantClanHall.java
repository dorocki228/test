...
import l2s.gameserver.listener.zone.impl.ResidenceEnterLeaveListener;
...
public class InstantClanHall extends ClanHall
{
	...
	private final TIntObjectMap<Clan> _owners;
	private final TIntObjectMap<Reflection> _reflections;
	private final OnReflectionCollapseListener _reflectionListener;

	public InstantClanHall(StatsSet set)
	{
		super(set);
		_owners = new TIntObjectHashMap<>();
		_reflections = new TIntObjectHashMap<>();
		_reflectionListener = new ReflectionCollapseListener();
