...
public class OlympiadGame extends ObservableArena
{
	...
	{
		ExGFXOlympiad.MatchResult packet = new ExGFXOlympiad.MatchResult(false, winnerMember.getName());
	...
	public void tie()
	{
		ExGFXOlympiad.MatchResult packet = new ExGFXOlympiad.MatchResult(true, StringUtils.EMPTY);
		try
		{
			if(_member1 != null)
			{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "OlympiadGame.tie(): %s", e );
		}
