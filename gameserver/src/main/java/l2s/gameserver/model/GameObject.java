...
public abstract class GameObject extends EventOwner implements GeoControl, ILocation
{
	...
	{
		_log.atWarning().log( "getCollisionRadius called directly from GameObject" );
		Thread.dumpStack();
		return 0;
	}
	...
	{
		_log.atWarning().log( "getCollisionHeight called directly from GameObject" );
		Thread.dumpStack();
		return 0;
	}
	...
	/**
	 * @return {@link Servitor} instance if current object is such, {@code null} otherwise.
	 */
	...
	/**
	 * @return {@link NpcInstance} instance if current object is such, {@code null} otherwise.
	 */
	...
	/**
	 * @return True if the object is minion of RaidBoss.
	 */
