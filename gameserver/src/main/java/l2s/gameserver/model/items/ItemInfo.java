...
public class ItemInfo
{
	...
	public ItemInfo(ItemInstance item, boolean isBlocked)
	{
		...
		setAugmentationMineralId(item.getAugmentationMineralId());
		setAugmentations(item.getAugmentations());
	...
	public void setAugmentations(int[] augmentations)
	{
	...
	public void setAugmentationMineralId(int augmentationMineralId)
	{
		_augmentationMineralId = augmentationMineralId;
	}
