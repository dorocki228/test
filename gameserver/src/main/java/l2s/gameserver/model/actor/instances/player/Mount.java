...
public class Mount
{
	...
	{
		return _data.getSpeedOnRide(stat);
	}
	...
	public void store()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Could not store mount current feed!" );
		}
		finally
		{
