...
public class CharListenerList extends ListenerList<Creature>
{
	...
	public void onAttackHit(Creature attacker, int damage, boolean crit, boolean miss)
	{
		if(!global.getListeners().isEmpty())
			for(Listener<Creature> listener : global.getListeners())
				if(OnAttackHitListener.class.isInstance(listener))
					((OnAttackHitListener) listener).onAttackHit(getActor(), attacker, damage, crit, miss);
	...
	public void onMagicUse(SkillEntry skillEntry, Creature target, boolean alt)
	{
		if(!global.getListeners().isEmpty())
			for(Listener<Creature> listener : global.getListeners())
				if(OnMagicUseListener.class.isInstance(listener))
					((OnMagicUseListener) listener).onMagicUse(getActor(), skillEntry, target, alt);
	...
	public void onCreatureSkillFinishCast(Creature target, Skill skill)
	{
		if(!global.getListeners().isEmpty())
			for(Listener<Creature> listener : global.getListeners())
				if(OnCreatureSkillFinishCastListener.class.isInstance(listener))
					((OnCreatureSkillFinishCastListener) listener).onCreatureSkillFinishCast(getActor(), target, skill);
	...
	public void onCurrentHpDamage(Creature attacker, double damage, Skill skill, boolean crit, boolean damageOverTime, boolean reflect)
	{
		if(!global.getListeners().isEmpty())
			for(Listener<Creature> listener : global.getListeners())
				if(OnCurrentHpDamageListener.class.isInstance(listener))
					((OnCurrentHpDamageListener) listener).onCurrentHpDamage(getActor(), attacker, damage, skill, crit, damageOverTime, reflect);
	...
	public void onCreatureDamageDealt(Creature target, double damage, Skill skill, boolean crit, boolean damageOverTime, boolean reflect)
	{
		if(!global.getListeners().isEmpty())
			for(Listener<Creature> listener : global.getListeners())
				if(listener instanceof OnCreatureDamageDealtListener)
					((OnCreatureDamageDealtListener) listener).onCreatureDamageDealt(getActor(), target, damage, skill, crit, damageOverTime, reflect);
	...
	public void onCreatureAttackAvoid(Creature attacker, boolean isDot)
	{
		if(!global.getListeners().isEmpty())
			for(Listener<Creature> listener : global.getListeners())
				if(listener instanceof OnCreatureAttackAvoidListener)
					((OnCreatureAttackAvoidListener) listener).onCreatureAttackAvoid(attacker, getActor(), isDot);
