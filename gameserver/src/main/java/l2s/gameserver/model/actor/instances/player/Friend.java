...
public class Friend
{
	...
	public void update(Player player, boolean set)
	{
		...
		_playerRef = (HardReference<Player>) (set ? player.getRef() : HardReferences.emptyRef());
	...
	public void setCreateTime(long time)
	{
		...
		_creationDay = calendar.get(Calendar.DATE);
		_creationMonth = calendar.get(Calendar.MONTH);
	}

	public int getLastAccessDelay()
	{
		return isOnline() ? -1 : (int) ((System.currentTimeMillis() - _lastAccess) / 1000L);
	}
}
