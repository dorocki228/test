...
public class CharStatsChangeRecorder<T extends Creature>
{
	...
	protected Set<AbnormalVisualEffect> abnormalVisualEffects = ConcurrentHashMap.newKeySet();
	...
	protected Set<AbnormalVisualEffect> set(int flag, Set<AbnormalVisualEffect> oldValue, Set<AbnormalVisualEffect> newValue)
	{
	...
	protected void refreshStats()
	{
		...
		abnormalVisualEffects = set(SEND_ABNORMAL_INFO, abnormalVisualEffects, _activeChar.getAbnormalEffects());
