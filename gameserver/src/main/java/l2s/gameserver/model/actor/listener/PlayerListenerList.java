...
/*
    public void onExpSpChange() {
        if (!global.getListeners().isEmpty())
            for (Listener<Creature> listener : global.getListeners())
                if (OnExpChangeListener.class.isInstance(listener))
                    ((OnExpChangeListener) listener).onExpChange(getActor());
    ...
    public void onZoneEnter(Zone zone) {
        if (!global.getListeners().isEmpty())
            for (Listener<Creature> listener : global.getListeners())
                if (OnPlayerZoneEnterLeaveListener.class.isInstance(listener))
                    ((OnPlayerZoneEnterLeaveListener) listener).onZoneEnter(getActor(), zone);
    ...
    public void onZoneLeave(Zone zone) {
        if (!global.getListeners().isEmpty())
            for (Listener<Creature> listener : global.getListeners())
                if (OnPlayerZoneEnterLeaveListener.class.isInstance(listener))
                    ((OnPlayerZoneEnterLeaveListener) listener).onZoneLeave(getActor(), zone);
