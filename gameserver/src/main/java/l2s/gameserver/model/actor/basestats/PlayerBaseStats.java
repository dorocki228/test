...
public class PlayerBaseStats extends PlayableBaseStats
{
	...
	public double getHpMax()
	{
		...
		else if(getOwner().isTransformed() && getOwner().getTransform().getBaseHpMax(getOwner().getLevel()) > 0.0)
	...
	public double getMpMax()
	{
		...
		else if(getOwner().isTransformed() && getOwner().getTransform().getBaseMpMax(getOwner().getLevel()) > 0.0)
	...
	{
		double maxCp;
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseCpMax(getOwner().getLevel()) > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseHpReg(getOwner().getLevel()) > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseMpReg(getOwner().getLevel()) > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseCpReg(getOwner().getLevel()) > 0.0)
	...
	{
		double pAtk;
		if(getOwner().isMounted() && getOwner().getMount().getPAtkOnRide() > 0.0)
			pAtk = getOwner().getMount().getPAtkOnRide();
		else if(getOwner().isTransformed() && getOwner().getTransform().getBasePAtk() > 0.0)
	...
	{
		double mAtk;
		if(getOwner().isMounted() && getOwner().getMount().getMAtkOnRide() > 0.0)
			mAtk = getOwner().getMount().getMAtkOnRide();
		else if(getOwner().isTransformed() && getOwner().getTransform().getBaseMAtk() > 0.0)
	...
	public double getPDef()
	{
		...
		ItemInstance tempItem = getOwner().getInventory().getPaperdollItem(10);
		if(tempItem != null)
			if(tempItem.getBodyPart() == 32768)
			{
        ...
        double result = 0.0;
        result += chestPDef;
		if(tempItem == null || tempItem.getBodyPart() != 32768)
		{
			tempItem = getOwner().getInventory().getPaperdollItem(11);
			if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(6);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(9);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(12);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(0);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(13);
		if(tempItem != null)
	...
	public double getMDef()
	{
		...
		ItemInstance tempItem = getOwner().getInventory().getPaperdollItem(2);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(1);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(3);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(5);
		if(tempItem != null)
		...
		tempItem = getOwner().getInventory().getPaperdollItem(4);
		if(tempItem != null)
	...
	public double getPAtkSpd()
	{
		...
		else if(getOwner().isTransformed() && getOwner().getTransform().getBasePAtkSpd() > 0.0)
	...
	{
		double mAtkSpd;
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseMAtkSpd() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseShldDef() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseShldRate() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBasePCritRate() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseMCritRate() > 0.0)
	...
	public double getRunSpd()
	{
		...
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseRunSpd() > 0.0)
	...
	public double getWalkSpd()
	{
		...
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseWalkSpd() > 0.0)
	...
	public double getWaterRunSpd()
	{
		...
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseWaterRunSpd() > 0.0)
	...
	public double getWaterWalkSpd()
	{
		...
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseWaterWalkSpd() > 0.0)
	...
	public double getFlyRunSpd()
	{
		if(getOwner().isMounted() && getOwner().getMount().getWaterRunSpdOnRide() > 0)
			return getOwner().getMount().getWaterRunSpdOnRide();
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseFlyRunSpd() > 0.0)
	...
	public double getFlyWalkSpd()
	{
		...
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseFlyWalkSpd() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseRideRunSpd() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseRideWalkSpd() > 0.0)
	...
	public double getCollisionRadius()
	{
		...
		{
			int mountTemplate = getOwner().getMountNpcId();
			if(mountTemplate != 0)
			{
		...
		if(getOwner().isVisualTransformed() && getOwner().getVisualTransform().getCollisionRadius() > 0.0)
	...
	public double getCollisionHeight()
	{
		...
		if(getOwner().isVisualTransformed() && getOwner().getVisualTransform().getCollisionHeight() > 0.0)
	...
	{
		if(getOwner().isTransformed() && getOwner().getTransform().getBaseAttackType() != WeaponTemplate.WeaponType.NONE)
