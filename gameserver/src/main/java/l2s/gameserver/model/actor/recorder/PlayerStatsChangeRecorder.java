...
public final class PlayerStatsChangeRecorder extends CharStatsChangeRecorder<Player>
{
	...
	private int _clan;
	private int privateBuyStoreLimit;
	private int privateSellStoreLimit;
	...
	protected void refreshStats()
	{
		...
		{
			_attackElement[e.getId()] = set(SEND_CHAR_INFO, _attackElement[e.getId()], _activeChar.getStat().getAttackElementValue(e));
			_defenceElement[e.getId()] = set(SEND_CHAR_INFO, _defenceElement[e.getId()], _activeChar.getStat().getDefenseElementValue(e));
		}
		...
		privateBuyStoreLimit = set(SEND_STORAGE_INFO, privateBuyStoreLimit, _activeChar.getPrivateBuyStoreLimit());
		privateSellStoreLimit = set(SEND_STORAGE_INFO, privateSellStoreLimit, _activeChar.getPrivateSellStoreLimit());
