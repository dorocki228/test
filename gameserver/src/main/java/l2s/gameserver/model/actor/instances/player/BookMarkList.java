...
public class BookMarkList
{
	...
	private static final int TELEPORT_SCROLL = 13016;
	public static final ZoneType[] FORBIDDEN_ZONES = {
			ZoneType.RESIDENCE,
			ZoneType.ssq_zone,
	...
	{
		return elementData.toArray(new BookMark[0]);
	}
	...
	{
		return elementData.size() < getCapacity() && elementData.add(e);
	}
	...
	public boolean tryTeleport(int slot)
	{
		...
		if(ItemFunctions.deleteItem(owner, TELEPORT_SCROLL, 1L))
		{
	...
	public boolean add(Location loc, String aname, String aacronym, int aiconId, boolean takeFlag)
	{
		...
		if(takeFlag && !ItemFunctions.deleteItem(owner, TELEPORT_FLAG_ID, 1L))
		{
