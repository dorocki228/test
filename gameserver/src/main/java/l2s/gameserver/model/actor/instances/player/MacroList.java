...
public class MacroList
{
	...
	private void registerMacroInDb(Macro macro)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "could not store macro: %s", macro );
		}
		finally
		{
	...
	private void deleteMacroFromDb(Macro macro)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "could not delete macro:" );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
	...
	public void restore()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "could not restore shortcuts:" );
		}
		finally
		{
