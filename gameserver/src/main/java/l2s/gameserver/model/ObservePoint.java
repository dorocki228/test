...
public class ObservePoint extends Creature
{
	...
	protected void onSpawn()
	{
		...
		{
			String messagePattern = "Movable observation point from player {} somehow appeared in main world!";
			ParameterizedMessage message = new ParameterizedMessage(messagePattern, getPlayer());
