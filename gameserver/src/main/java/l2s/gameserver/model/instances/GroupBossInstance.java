 ...
 * @author KRonst
 */
public class GroupBossInstance extends MonsterInstance {

    public GroupBossInstance(int objectId, NpcTemplate template, MultiValueSet<String> set) {
    ...
    public void rollRewards(RewardList list, Creature lastAttacker, Creature topDamager) {
        ...
        int minDamageForReward = getMaxHp() * Config.GROUP_BOSSES_DAMAGE_PERCENT_FOR_REWARD_AMOUNT / 100;
