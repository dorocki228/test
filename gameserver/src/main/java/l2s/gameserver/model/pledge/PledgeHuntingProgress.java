...
public class PledgeHuntingProgress implements JdbcEntity
{
	...
	public void update()
	{
		...
		if(clanId == 0)
		{
			_log.atWarning().log( "HuntingProgress#update() with empty ClanId" );
			Thread.dumpStack();
			return;
		}
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "HuntingProgress#update(): " );
		}
		finally
		{
