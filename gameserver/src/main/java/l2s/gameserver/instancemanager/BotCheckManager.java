...
public class BotCheckManager
{
	...
	public static CopyOnWriteArrayList<BotCheckQuestion> questionInfo;
	...
	static
	{
		_log = LoggerFactory.getLogger(BotCheckManager.class);
		questionInfo = new CopyOnWriteArrayList<>();
	}
