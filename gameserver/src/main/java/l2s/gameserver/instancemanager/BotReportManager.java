...
public final class BotReportManager
{
	...
	private class SaveReportedTask implements Runnable
	{
		...
		public void run()
		{
			...
			_log.atInfo().log( "BotReportManager: Reports saved." );
		}
	}
	...
	private void loadReportedCharData()
	{
		...
		try
		{
			...
			_log.atInfo().log( "BotReportManager: Loaded %s bot reports.", lazy(() -> _reports.size()) );
		}
		catch(Exception e)
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "BotReportManager: Could not load reported char data!" );
		}
		finally
		{
	...
	public void saveReportedCharData()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "BotReportManager: Could not update reported char data in database!" );
		}
		finally
		{
