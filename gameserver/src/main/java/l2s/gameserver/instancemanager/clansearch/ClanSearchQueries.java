...
public class ClanSearchQueries
{
	...
	public static final String ADD_CLAN = "INSERT INTO `clan_search_registered_clans`(`clan_id`, `search_type`, `title`, `desc`, `timestamp`) VALUES (?, ?, ?, ?, UNIX_TIMESTAMP()) ON DUPLICATE KEY UPDATE `search_type` = ?, `title` = ?, `desc` = ?";
