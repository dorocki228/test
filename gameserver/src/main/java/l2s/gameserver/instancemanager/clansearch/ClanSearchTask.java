...
public class ClanSearchTask implements Runnable
{
	...
	{
		_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "%s: Failed to update database for clan search system.", getClass().getSimpleName() );
	}
