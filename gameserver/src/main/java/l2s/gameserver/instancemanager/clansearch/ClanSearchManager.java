...
public class ClanSearchManager
{
	...
	public void load()
	{
		_log.atInfo().log( "%s: Loading clan search data...", lazy(() -> getClass().getSimpleName()) );
		...
		try
		{
			...
			while(result.next())
			{
				...
				{
					_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "%s: Failed to load Clan Search Engine clan row.", getClass().getSimpleName() );
				}
			}
			...
			while(result.next())
			{
				...
				{
					_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "%s: Failed to load Clan Search Engine applicant.", getClass().getSimpleName() );
				}
			}
			...
			while(result.next())
			{
				...
				{
					_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "%s: Failed to load Clan Search Engine waiter.", getClass().getSimpleName() );
				}
			}
		}
		catch(SQLException e)
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "%s: Failed to load Clan Search Engine clan list.", getClass().getSimpleName() );
		}
		finally
		{
		...
		_log.atInfo().log( "%s: Loaded %s registered clans.", lazy(() -> getClass().getSimpleName()), lazy(() -> _registeredClans.size()) );
		_log.atInfo().log( "%s: Loaded %s registered players.", lazy(() -> getClass().getSimpleName()), lazy(() -> _applicantPlayers.size()) );
	...
	public void save()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "%s: Failed run save task.", getClass().getSimpleName() );
		}
	}
}