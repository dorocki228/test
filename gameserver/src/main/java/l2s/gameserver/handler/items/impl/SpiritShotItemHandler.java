...
public class SpiritShotItemHandler extends DefaultItemHandler
{
	...
	static
	{
		SHOT_SKILLS.put(ItemGrade.NONE.ordinal(), 2047);
		SHOT_SKILLS.put(ItemGrade.D.ordinal(), 2155);
		SHOT_SKILLS.put(ItemGrade.C.ordinal(), 2156);
		SHOT_SKILLS.put(ItemGrade.B.ordinal(), 2157);
		SHOT_SKILLS.put(ItemGrade.A.ordinal(), 2158);
		SHOT_SKILLS.put(ItemGrade.S.ordinal(), 2159);
		SHOT_SKILLS.put(ItemGrade.R.ordinal(), 9194);
	}
}
