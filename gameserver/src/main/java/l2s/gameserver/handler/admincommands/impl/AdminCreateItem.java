...
public class AdminCreateItem implements IAdminCommandHandler
{
		...
		switch(command)
		{
			...
			case admin_create_item_element:
				try
				{
					...
					AttributeType attributeType = AttributeType.getElementById(elementId);
					item.setAttributeElement(attributeType, item.getAttributeElementValue(attributeType, false) + value);
	...
	private ItemInstance createItem(Player activeChar, int itemId, long count)
	{
		...
		createditem.setCount(count);
		ItemLogger.INSTANCE.log(ItemProcess.Create, activeChar, createditem);
