	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_teleport:
			{
				...
				int z_loc = ArrayUtils.valid((Object[]) wordList, 3) != null && !((String) ArrayUtils.valid((Object[]) wordList, 3)).isEmpty() ? Integer.parseInt(wordList[3]) : Config.MAP_MAX_Z;
				int ref = ArrayUtils.valid((Object[]) wordList, 4) != null && !((String) ArrayUtils.valid((Object[]) wordList, 4)).isEmpty() ? Integer.parseInt(wordList[4]) : 0;
		...
		switch(command)
		{
			...
			case admin_getref:
			{
				...
				Player cha2 = GameObjectsStorage.getPlayer(wordList[1]);
				if(cha2 == null)
				{
