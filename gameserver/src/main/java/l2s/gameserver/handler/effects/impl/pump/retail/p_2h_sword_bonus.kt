 ...
 * @since 12.10.2019
 */
class p_2h_sword_bonus(template: EffectTemplate) : EffectHandler(template) {

    private val pAtkAmount = params.getDouble("p_2h_sword_bonus_param1")
    private val pAtkmode =
            params.getEnum(
                    "p_2h_sword_bonus_param2",
                    StatModifierType::class.java,
                    true
            )

    private val accuracyAmount = params.getDouble("p_2h_sword_bonus_param3")
    private val accuracyMode = params.getEnum(
            "p_2h_sword_bonus_param4",
            StatModifierType::class.java,
            true
    )
    ...
    override fun checkPumpCondition(abnormal: Abnormal?, caster: Creature, target: Creature): Boolean {
        ...
        val blunt = weaponTemplate.itemType == WeaponTemplate.WeaponType.SWORD
                || weaponTemplate.itemType == WeaponTemplate.WeaponType.ANCIENTSWORD
                || weaponTemplate.itemType == WeaponTemplate.WeaponType.BIGSWORD
