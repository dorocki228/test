...
/**
 * Special Mute effect implementation.
 * @author -Nemesiss-
 * @author Java-man
 */
class p_block_skill_special(template: EffectTemplate) :
        AbstractBooleanStatEffect(template, BooleanStat.SPECIAL_SKILL_MUTED) {
    ...
    override fun pumpStart(abnormal: Abnormal?, caster: Creature, target: Creature) {
        ...
        if (castingSkillEntry != null && castingSkillEntry.template.isSpecial) {
