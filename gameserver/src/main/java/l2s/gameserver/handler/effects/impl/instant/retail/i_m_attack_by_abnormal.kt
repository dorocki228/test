 ...
 * @author Java-man
 */
class i_m_attack_by_abnormal(template: EffectTemplate) : i_abstract_effect(template) {

    private val _power = params.getDouble("i_m_attack_by_abnormal_param1")
    ...
    override fun instantUse(caster: Creature, target: Creature, soulShotUsed: AtomicBoolean, reflected: Boolean, cubic: Cubic) {
        ...
        damage *= (targetCreature.abnormalList.buffCount * 0.3 + 1.3) / 4.0
