...
/**
 * Trigger Damage By Attack effect implementation.
 * @author Java-man
 */
class p_trigger_damage_by_attack(template: EffectTemplate) : EffectHandler(template) {
    ...
    init {
        val param1 = params.getString("p_trigger_damage_by_attack_param1")
                .split(";")
        ...
        val param2 = params.getIntegerArray("p_trigger_damage_by_attack_param2")
        ...
        val param3 = params.getString("p_trigger_damage_by_attack_param3")
                .split(";")
        minDamage = param3[0].toInt()
        chance = param3[1].toInt()

        damage = params.getDouble("p_trigger_damage_by_attack_param4")

        targetType = params.getEnum(
                "p_trigger_damage_by_attack_param5",
        ...
        val param6 = params.getString("p_trigger_damage_by_attack_param6")
        if (param6 == "all") {
            allowWeapons = 0
        } else {
