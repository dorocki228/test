 ...
 * @since 16.10.2019
 */
class p_critical_damage_position(template: EffectTemplate) : EffectHandler(template) {

    private val position = params.getEnum(
            "p_critical_damage_position_param1",
            Position::class.java,
            true
    )
    private val amount = params.getDouble("p_critical_damage_position_param2")
    private val modifierType =
            params.getEnum(
                    "p_critical_damage_position_param3",
