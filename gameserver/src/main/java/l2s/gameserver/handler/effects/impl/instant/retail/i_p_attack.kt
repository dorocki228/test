 ...
 * @author Java-man
 */
class i_p_attack(template: EffectTemplate) : i_abstract_effect(template) {

    private val power = params.getDouble("i_p_attack_param1")
    private val criticalChance = params.getDouble("i_p_attack_param2")
    private val ignoreDefMode = params.getInteger("i_p_attack_param3")
    private val ignoreDefFactor = params.getInteger("i_p_attack_param4")
