...
{
	public static List<Location> findPath(final int fromX, final int fromY, int fromZ, final int toX, final int toY, int toZ, final boolean isPlayable, final int geoIndex)
	{
