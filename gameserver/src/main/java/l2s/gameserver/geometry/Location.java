...
public class Location extends Point3D implements ILocation, SpawnRange
{
	...
	public static Location findAroundPosition(ILocation loc, int radius, int geoIndex)
	{
		return findAroundPosition(loc.getX(), loc.getY(), loc.getZ(), 0, radius, geoIndex);
	}

	public static Location findAroundPosition(ILocation loc, int radiusmin, int radiusmax, int geoIndex)
	{
