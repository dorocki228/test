...
public class SparseBitSetIdFactory extends IdFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(SparseBitSetIdFactory.class);

    private SparseBitSet freeIds;
    ...
    protected SparseBitSetIdFactory() {
        initialize();
    ...
    private void initialize() {
        try {
            freeIds = new SparseBitSet(PrimeFinder.nextPrime(100000));
            freeIds.clear();
    ...
    protected synchronized void increaseBitSetCapacity() {
        SparseBitSet newBitSet = new SparseBitSet(PrimeFinder.nextPrime(usedIdCount() * 11 / 10));
