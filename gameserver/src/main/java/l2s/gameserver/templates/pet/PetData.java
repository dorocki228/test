...
public class PetData
{
	...
	private int _minLvl;
	private int _maxLvl;
	private final List<RewardItemData> _expirationRewardItems;

	public PetData(int npcId, int controlItemId, int[] syncLevels, PetType type, MountType mountType)
	{
		_minLvl = 0;
		_maxLvl = 0;
		_expirationRewardItems = new ArrayList<>();
		_npcId = npcId;
	...
	{
		return _skills.toArray(new PetSkillData[0]);
	}
	...
	{
		return _expirationRewardItems.toArray(new RewardItemData[0]);
	}
}
