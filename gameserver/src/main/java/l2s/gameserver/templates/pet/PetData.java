...
public class PetData
{
	...
	public Optional<Double> getPAtk(int level)
	{
		return getLvlData(level).getPAtk();
	}

	public Optional<Double> getPDef(int level)
	{
		return getLvlData(level).getPDef();
	}

	public Optional<Double> getMAtk(int level)
	{
		return getLvlData(level).getMAtk();
	}

	public Optional<Double> getMDef(int level)
	{
		return getLvlData(level).getMDef();
	}

	public Optional<Double> getHP(int level)
	{
		return getLvlData(level).getHP();
	}

	public Optional<Double> getMP(int level)
	{
		return getLvlData(level).getMP();
	}

	public Optional<Double> getHPRegen(int level)
	{
		return getLvlData(level).getHPRegen();
	}

	public Optional<Double> getMPRegen(int level)
	{
