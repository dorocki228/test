...
public final class RecipeTemplate
{
	...
	private boolean canBeCriticalCrafted;
	...
	public boolean isCanBeCriticalCrafted() {
		return canBeCriticalCrafted;
	}

	public void setCanBeCriticalCrafted(boolean canBeCriticalCrafted) {
		this.canBeCriticalCrafted = canBeCriticalCrafted;
	}
}