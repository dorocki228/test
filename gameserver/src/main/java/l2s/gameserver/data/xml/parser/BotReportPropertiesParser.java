...
{
	private static final BotReportPropertiesParser _instance;
	...
	protected void readData(Element rootElement) throws Exception
	{
		...
		while(iterator.hasNext())
		{
			...
			Iterator<Element> punishmentsIterator = punishmentsElement.elementIterator("punishment");
	...
	static
	{
		_instance = new BotReportPropertiesParser();
	}
}
