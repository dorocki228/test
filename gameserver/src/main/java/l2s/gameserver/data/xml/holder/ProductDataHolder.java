...
{
	private static final ProductDataHolder _instance;
	private final TIntObjectMap<ProductItem> _products;

	public ProductDataHolder()
	{
		_products = new TIntObjectHashMap<>();
	}
	...
	static
	{
		_instance = new ProductDataHolder();
	}
}
