...
{
	private static final ShuttleTemplateHolder _instance;
	private final TIntObjectHashMap<ShuttleTemplate> _templates;

	public ShuttleTemplateHolder()
	{
	...
	static
	{
		_instance = new ShuttleTemplateHolder();
	}
}
