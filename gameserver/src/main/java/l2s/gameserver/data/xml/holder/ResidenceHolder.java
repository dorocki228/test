...
public final class ResidenceHolder extends AbstractHolder
{
	...
	{
		Residence residenceByCoord = getResidenceByCoord(type, object.getX(), object.getY(), object.getZ(), object.getReflection());
		if (residenceByCoord == null) {
			return null;
		}
		return (R) residenceByCoord;
	}
