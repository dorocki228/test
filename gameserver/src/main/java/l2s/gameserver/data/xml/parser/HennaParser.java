...
{
	private static final HennaParser _instance;
	...
	protected void readData(Element rootElement) throws Exception
	{
		...
		while(iterator.hasNext())
		{
			...
			Iterator<Element> classIterator = hennaElement.elementIterator("class");
			...
			Iterator<Element> skillsIterator = hennaElement.elementIterator("skills");
			while(skillsIterator.hasNext())
			{
				Element skillsElement = skillsIterator.next();
				Iterator<Element> skillIterator = skillsElement.elementIterator("skill");
