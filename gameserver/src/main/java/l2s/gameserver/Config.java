...
public class Config
{
	...
	public static final String CUSTOM_SCHEME_BUFFER_CONFIG_FILE = "config/scheme_buffer.properties";
	...
	/** Private store name template */
	public static String PRIVATE_STORE_NAME_TEMPLATE;
	...
	public static boolean ENABLE_TUTORIAL;
	...
	public static AbnormalVisualEffect SERVICES_OFFLINE_TRADE_ABNORMAL_EFFECT;
	...
	public static Path CUSTOM_PATH;
	...
	public static boolean SONGDANCE_SELF_DISPELLABLE;
	...
	public static double LIM_MATK_SPD;
	public static double LIM_PATK_SPD;
	public static int LIM_CRIT_DAM;
	public static double LIM_CRIT;
	public static double LIM_MCRIT;
	public static int LIM_ACCURACY;
	public static double LIM_EVASION;
	public static double LIM_MOVE;
	public static int LIM_FAME;
	public static int LIM_RAID_POINTS;
	public static double HP_LIMIT;
	public static double MP_LIMIT;
	public static double CP_LIMIT;
	...
	public static int CLAN_LEVEL_1_LIMIT;
	public static int CLAN_LEVEL_2_LIMIT;
	public static int CLAN_LEVEL_3_LIMIT;
	public static int CLAN_LEVEL_4_LIMIT;
	public static int CLAN_LEVEL_5_LIMIT;
	...
	public static double ELEMENT_ATTACK_LIMIT;
	...
	public static boolean BETA_SERVER;
	...
	public static int TELEPORT_FREE_UNTIL_LEVEL;
	...
	public static int CB_MAX_SCHEMES_PER_CHAR;
	public static int CB_MAX_SKILLS_PER_SCHEME;
	public static int CB_MAX_DANCES_SONGS_PER_SCHEME;
	public static int CB_MAX_BUFFS_PER_SCHEME;
	public static long CB_BUFFER_STATIC_COST_PER_BUFF;
	public static long CB_SCHEME_USE_PRICE;
	public static long CB_RESTORE_PRICE;
	public static int CB_BUFFER_PAYMENT_ITEM;
	...
	public static void loadServerConfig()
	{
		...
		PRIVATE_STORE_NAME_TEMPLATE = serverSettings.getProperty("PrivateStoreNameTemplate", "[0-9A-Za-z\\s]{1,32}");
		...
		String customFolder = serverSettings.getProperty("CustomFolder", "custom");
		CUSTOM_PATH = DATAPACK_ROOT_PATH.resolve(customFolder);

		SCRIPTS_PATH = serverSettings.getProperty("ScriptsPath", Path.of("."));
		...
		BETA_SERVER = serverSettings.getProperty("BetaServer", false);
	}
	...
	public static void loadFormulasConfig()
	{
		...
		MIN_ABNORMAL_SUCCESS_RATE = formulasSettings.getProperty("MIN_ABNORMAL_SUCCESS_RATE", 0.0);
		...
		LIM_CRIT = formulasSettings.getProperty("LimitCritical", 500.0);
		LIM_MCRIT = formulasSettings.getProperty("LimitMCritical", 20.0);
		LIM_ACCURACY = formulasSettings.getProperty("LimitAccuracy", 200);
		LIM_EVASION = formulasSettings.getProperty("LimitEvasion", 250.0);
		LIM_MOVE = formulasSettings.getProperty("LimitMove", 300.0);
		HP_LIMIT = formulasSettings.getProperty("HP_LIMIT", 150000.0);
		MP_LIMIT = formulasSettings.getProperty("MP_LIMIT", -1.0);
		CP_LIMIT = formulasSettings.getProperty("CP_LIMIT", -1.0);
		...
		ELEMENT_ATTACK_LIMIT = formulasSettings.getProperty("ELEMENT_ATTACK_LIMIT", 999.0);
	}
	...
	public static void loadAltSettings()
	{
		...
		ENABLE_TUTORIAL = altSettings.getProperty("EnableTutorial", true);
		...
		SONGDANCE_SELF_DISPELLABLE = altSettings.getProperty("SongDanceSelfDispellable", false);
		...
		CLAN_LEVEL_1_LIMIT = altSettings.getProperty("CLAN_LEVEL_1_LIMIT", 10);
		CLAN_LEVEL_2_LIMIT = altSettings.getProperty("CLAN_LEVEL_2_LIMIT", 15);
		CLAN_LEVEL_3_LIMIT = altSettings.getProperty("CLAN_LEVEL_3_LIMIT", 20);
		CLAN_LEVEL_4_LIMIT = altSettings.getProperty("CLAN_LEVEL_4_LIMIT", 30);
		CLAN_LEVEL_5_LIMIT = altSettings.getProperty("CLAN_LEVEL_5_LIMIT", 40);
		...
		TELEPORT_FREE_UNTIL_LEVEL = altSettings.getProperty("TeleportFreeUntilLevel", 0);

		MULTICLASS_SYSTEM_ENABLED = altSettings.getProperty("MULTICLASS_SYSTEM_ENABLED", true);
		MULTICLASS_SYSTEM_SHOW_LEARN_LIST_ON_OPEN_SKILL_LIST = altSettings.getProperty("MULTICLASS_SYSTEM_SHOW_LEARN_LIST_ON_OPEN_SKILL_LIST", true);
	...
	public static void loadServicesSettings()
	{
		...
		SERVICES_OFFLINE_TRADE_ABNORMAL_EFFECT = AbnormalVisualEffect.valueOf(servicesSettings.getProperty("OfflineTradeAbnormalEffect", "NONE").toUpperCase());
	...
	public static void pvpManagerSettings()
	{
		...
		if(PVP_REWARD_REWARD_IDS.length != PVP_REWARD_COUNTS.length)
			_log.atWarning().log( "pvp_manager.properties: PvPRewardsIDs array length != PvPRewardsCounts array length" );
	...
	public static void load()
	{
		...
		pvpManagerSettings();
		loadAntiBotSettings();
		loadCustomSchemeBufferSettings();
	}
	...
	public static void abuseLoad()
	{
		...
		try
		{
			...
			_log.atInfo().log( "Abuse: Loaded %s abuse words.", count );
		}
		catch(IOException e1)
		{
			_log.atWarning().log( "Error reading abuse: %s", e1 );
		}
		finally
		{
			try
	...
	public static void loadCustomSchemeBufferSettings()
	{
		ExProperties properties = load(CUSTOM_SCHEME_BUFFER_CONFIG_FILE);

		CB_MAX_SCHEMES_PER_CHAR = properties.getProperty("BufferMaxSchemesPerChar", 24);
		CB_MAX_SKILLS_PER_SCHEME = properties.getProperty("MaxSkillsPerScheme", 24);
		CB_MAX_DANCES_SONGS_PER_SCHEME = properties.getProperty("MaxDancesSongsPerScheme", 24);
		CB_MAX_BUFFS_PER_SCHEME = properties.getProperty("MaxBuffsPerScheme", 24);
		CB_BUFFER_STATIC_COST_PER_BUFF = properties.getProperty("BufferStaticCostPerBuff", 0);
		CB_SCHEME_USE_PRICE = properties.getProperty("SchemeUsePrice", 0L);
		CB_RESTORE_PRICE = properties.getProperty("RestorePrice", 0L);
		CB_BUFFER_PAYMENT_ITEM = properties.getProperty("BufferPaymentItem", 57);
	}
	...
	public static void loadGMAccess()
	{
		...
		{
			_log.atInfo().log( "Dir %s not exists.", lazy(() -> dir.getAbsolutePath()) );
			return;
		}
			...
			for(Node z = doc.getFirstChild(); z != null; z = z.getNextSibling())
				for(Node n = z.getFirstChild(); n != null; n = n.getNextSibling())
				{
					...
					for(Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
					{
						...
						{
							_log.atInfo().log( "Not found desclarate ACCESS name: %s in XML Player access Object", node );
							continue;
						}
	...
	public static ExProperties load(File file)
	{
		...
		{
			_log.atSevere().log( "Error loading config : %s!", file.getName() );
		}
