	...
	public void run(l2s.gameserver.network.l2.GameClient client)
	{
		...
		try
		{
			...
			for(TradeItem ti : tradeList1)
			{
				...
				ItemLogger.INSTANCE.log(ItemProcess.TradeSell, parthner1, item);
				ItemLogger.INSTANCE.log(ItemProcess.TradeBuy, parthner2, item);
			...
			for(TradeItem ti : tradeList2)
			{
				...
				ItemLogger.INSTANCE.log(ItemProcess.TradeSell, parthner2, item);
				ItemLogger.INSTANCE.log(ItemProcess.TradeBuy, parthner1, item);
