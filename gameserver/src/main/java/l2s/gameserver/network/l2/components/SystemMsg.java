...
public enum SystemMsg implements IBroadcastPacket
{
	...
	// Message: Drain was only 50%% successful.
	...
	// Message: $c1 is in an area which blocks summoning or teleporting.
	C1_IS_IN_AN_AREA_WHICH_BLOCKS_SUMMONING_OR_TELEPORTING(1895),
	...
	// Message: $c1 is in an area which blocks summoning or teleporting.
	C1_IS_IN_AN_AREA_WHICH_BLOCKS_SUMMONING_OR_TELEPORTING2(1908),
	...
	// Message: $c1 dodged the attack.
	C1_DODGED_THE_ATTACK(1999),
	// Message: You have dodged $c1's attack.
	YOU_HAVE_DODGED_C1S_ATTACK(2000),
	...
	// Message: <$s1> will evolve to <$s2>. Spirits can grow up to Lv. 10.
	S1_WILL_EVOLVE_TO_S2_SPIRITS_CAN_GROW_UP_TO_LV_10(5108),
	// Message: <$s1> evolved to <$s2-Star>!
	S1_EVOLVED_TO_S2STAR(5109),
	// Message: <$s1, $s2> will be extracted with a card.
	S1_S2_WILL_BE_EXTRACTED_WITH_A_CARD(5110),
	// Message: Extracted <$s1, $s2> successfully!
	EXTRACTED_S1_S2_SUCCESSFULLY(5111),
	// Message: Add a material for absorption.
	ADD_A_MATERIAL_FOR_ABSORPTION(5112),
	// Message: Cannot evolve/absorb/extract while using the private store/workshop.
	CANNOT_EVOLVEABSORBEXTRACT_WHILE_USING_THE_PRIVATE_STOREWORKSHOP(5113),
	// Message: Succesful absorption!
	SUCCESFUL_ABSORPTION(5114),
	// Message: Characteristics Points will be used to enhance the stats of <$s1>. You can retrieve these points by resetting the stats. Are you sure you want to continue?
	CHARACTERISTICS_POINTS_WILL_BE_USED_TO_ENHANCE_THE_STATS_OF_S1_YOU_CAN_RETRIEVE_THESE_POINTS_BY_RESETTING_THE_STATS_ARE_YOU_SURE_YOU_WANT_TO_CONTINUE(5115),
	// Message: Characteristics were applied successfully.
	CHARACTERISTICS_WERE_APPLIED_SUCCESSFULLY(5116),
	// Message: The following ingredients will be consumed and <$s1> Characteristics Points will be lost to reset the characteristics of the selected spirit. Are you sure you want to continue?
	THE_FOLLOWING_INGREDIENTS_WILL_BE_CONSUMED_AND_S1_CHARACTERISTICS_POINTS_WILL_BE_LOST_TO_RESET_THE_CHARACTERISTICS_OF_THE_SELECTED_SPIRIT_ARE_YOU_SURE_YOU_WANT_TO_CONTINUE(5117),
	...
	// Message: Only macros can be registered.
	ONLY_MACROS_CAN_BE_REGISTERED(5270),
