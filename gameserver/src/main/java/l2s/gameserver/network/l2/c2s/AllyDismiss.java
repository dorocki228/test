...
public class AllyDismiss implements IClientIncomingPacket
{
	...
	public void run(l2s.gameserver.network.l2.GameClient client)
	{
		...
		if(clan != null)
		{
			...
			//activeChar.sendMessage(new CustomMessage("l2s.gameserver.network.l2.c2s.AllyDismiss.ClanDismissed").addString(clan.getName()).addString(alliance.getAllyName()));
		}
	}
}