 ...
 * @author Bonux
**/
public class ElementalSpiritAbsorb implements IClientOutgoingPacket
{
	private final boolean _success;
	private final Elemental _elemental;

	public ElementalSpiritAbsorb(Player player, boolean success, int elementId)
	{
		_success = success;
	...
	{
		OutgoingExPackets.EX_ELEMENTAL_SPIRIT_ABSORB.writeId(packetWriter);
