...
public enum NpcString
{
	...
	S1_S_COMMAND_CHANNEL_HAS_LOOTING_RIGHTS(1800009),
	OLYMPIAD_CLASS_FREE_INDIVIDUAL_MATCH_IS_GOING_TO_BEGIN_IN_ARENA_S1_IN_A_MOMENT(1300166);
