...
public class RequestNewEnchantPushTwo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		ItemInstance item2 = activeChar.getInventory().getItemByObjectId(_item2ObjectId);
		if(item2 == null)
		{
		...
		{
			if((item1 == null || item1.getItemId() == d.getSlotone()) && item2.getItemId() == d.getSlottwo())
			{
				data = d;
				break;
			}

			if(item1 != null && item1.getItemId() != d.getSlottwo() || item2.getItemId() != d.getSlotone())
				continue;
