...
public enum OutgoingExPackets {
    ...
    EX_REPLY_SENT_POST,
    EX_RESPONSE_SHOWSTEP_ONE,
    EX_RESPONSE_SHOWSTEP_TWO,
    EX_RESPONSE_SHOWCONTENTS,
    EX_RESPONSE_SHOWSTEP_THREE,
    ...
    EX_BR_LOAD_EVENT_TOP_RANKERACK,
    EX_CHANGE_NPC_STATE,
    ...
    EX_ABNORMAL_STATUUPDATE_FROM_TARGET,
    ...
    EX_SHOW_STAT_PAGE,
    EX_CHECK_CHAR_NAME,
    EX_GOODINVENTORY_CHANGED_NOTI,
    EX_GOODINVENTORY_INFO,
    EX_GOODINVENTORY_RESULT,
    ...
    EX_CURIOUHOUSE_STATE,
    EX_CURIOUHOUSE_ENTER,
    EX_CURIOUHOUSE_LEAVE,
    EX_CURIOUHOUSE_MEMBER_LIST,
    EX_CURIOUHOUSE_MEMBER_UPDATE,
    EX_CURIOUHOUSE_REMAIN_TIME,
    EX_CURIOUHOUSE_RESULT,
    EX_CURIOUHOUSE_OBSERVE_LIST,
    EX_CURIOUHOUSE_OBSERVE_MODE,
    EX_SYSTRING,
    ...
    EX_USER_INFO_CUBIC,
    EX_USER_INFO_ABNORMALVISUALEFFECT,
    ...
    EX_TRAININGZONE_ADMISSION,
    EX_TRAININGZONE_LEAVING,
    EX_PERIODIC_HENNA,
    EX_SHOW_AP_LIST_WND,
    EX_USER_INFO_INVENWEIGHT,
    ...
    EX_ENCHANT_SUCCESS,
    EX_ENCHANT_FAIL,
    EX_ENCHANT_RETRY_TO_PUT_ITEMOK,
    EX_ENCHANT_RETRY_TO_PUT_ITEMFAIL,
    ...
    EX_START_CHOOSE_CLASARENA,
    EX_CHANGE_CLASARENA,
    EX_CONFIRM_CLASARENA,
    ...
    EX_JOB_CHANGE_ICON(522),
    EX_COSTUME_USE_ITEM(523),
    EX_CHOOSE_COSTUME_ITEM(524),
    EX_SEND_COSTUME_LIST(525),
    EX_SEND_COSTUME_LIST_FULL(526),
    EX_COSTUME_COLLECTION_SKILL_ACTIVE(527),
    EX_COSTUME_EVOLUTION(528),
    EX_COSTUME_EXTRACT(529),
    EX_COSTUME_LOCK(530),
    EX_COSTUME_SHORTCUT_LIST(531),
    EX_MAGICLAMP_EXP_INFO,
    EX_MAGICLAMP_GAME_INFO,
    EX_MAGICLAMP_GAME_RESULT,
    EX_SHOW_TELEPORT_UI,
    EX_ACTIVATE_AUTO_SHORTCUT(536),
    ...
    EX_DIE_INFO,
    EX_AUTOPLAY_SETTING(543),
    EX_AUTOPLAY_DO_MACRO(544),
    EX_FESTIVAL_BM_INFO,
    EX_FESTIVAL_BM_ALL_ITEM_INFO,
    EX_FESTIVAL_BM_TOP_ITEM_INFO,
    EX_FESTIVAL_BM_GAME,
    EX_RANKING_CHAR_INFO(558),
    EX_RANKING_CHAR_HISTORY(559),
    EX_RANKING_CHAR_RANKERS(560),
    EX_BOW_ACTION_TO(61);
