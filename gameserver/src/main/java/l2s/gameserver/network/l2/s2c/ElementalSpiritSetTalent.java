 ...
 * @author Bonux
**/
public class ElementalSpiritSetTalent implements IClientOutgoingPacket
{
	private final boolean _success;
	private final Elemental _elemental;

	public ElementalSpiritSetTalent(Player player, boolean success, int elementId)
	{
		_success = success;
	...
	{
		OutgoingExPackets.EX_ELEMENTAL_SPIRIT_SET_TALENT.writeId(packetWriter);
