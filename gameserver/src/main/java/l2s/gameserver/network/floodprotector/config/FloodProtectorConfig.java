...
public final class FloodProtectorConfig
{
	 ...
	 */
	public Duration FLOOD_PROTECTION_INTERVAL;
	/**
	...
	/**
	 * Punishment type. Either 'ignore', 'kick', 'ban' or 'jail'.
	 */
	...
	public static FloodProtectorConfig load(final String type, final ExProperties properties)
	{
		...
		int property = properties.getProperty(type + "_FLOOD_PROTECTION_INTERVAL", 1000);
		config.FLOOD_PROTECTION_INTERVAL = Duration.ofMillis(property);
		...
		config.PUNISHMENT_TYPE = properties.getProperty(type + "_PUNISHMENT_TYPE", "ignore");
