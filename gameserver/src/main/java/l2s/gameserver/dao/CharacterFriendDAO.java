...
public class CharacterFriendDAO
{
	...
	private static final CharacterFriendDAO _instance;
	...
	{
		TIntObjectMap<Friend> map = new TIntObjectHashMap();
		Connection con = null;
	...
	static
	{
		_log = LoggerFactory.getLogger(CharacterFriendDAO.class);
		_instance = new CharacterFriendDAO();
	}
}
