...
public class CharacterPostFriendDAO
{
	...
	public IntObjectMap<String> select(Player player)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterPostFriendDAO.load(L2Player): %s", e );
		}
		finally
		{
	...
	public void insert(Player player, int val)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterPostFriendDAO.insert(L2Player, int): %s", e );
		}
		finally
		{
	...
	public void delete(Player player, int val)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterPostFriendDAO.delete(L2Player, int): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
