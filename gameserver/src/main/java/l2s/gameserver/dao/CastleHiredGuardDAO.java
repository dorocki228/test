...
public class CastleHiredGuardDAO
{
	...
	public void load(Castle r)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CastleHiredGuardDAO:load(Castle): %s", e );
		}
		finally
		{
	...
	public void insert(Residence residence, int itemId, Location loc)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CastleHiredGuardDAO:insert(Residence, int, Location): %s", e );
		}
		finally
		{
	...
	public void delete(Residence residence, ItemInstance item)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CastleHiredGuardDAO:delete(Residence): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
