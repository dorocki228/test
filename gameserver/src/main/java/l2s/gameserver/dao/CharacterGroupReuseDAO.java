...
public class CharacterGroupReuseDAO
{
	...
	public void select(Player player)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterGroupReuseDAO.select(Player):" );
		}
		finally
		{
	...
	public void insert(Player player)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterGroupReuseDAO.insert(Player):" );
		}
		finally
		{
