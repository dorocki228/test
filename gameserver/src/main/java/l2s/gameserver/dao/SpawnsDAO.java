...
public class SpawnsDAO
{
	...
	public List<SpawnTemplate> restore()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SpawnsDAO:restore()" );
		}
		finally
		{
	...
	public boolean insert(int npcId, int x, int y, int z, int heading, int respawn, int count)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SpawnsDAO:insert(npcId,x,y,z,heading,respawn,count)" );
			return false;
		}
		finally
		{
	...
	public boolean delete(NpcInstance npc)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SpawnsDAO:delete(npc)" );
			return false;
		}
		finally
		{
