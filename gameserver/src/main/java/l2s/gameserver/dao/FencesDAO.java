...
public class FencesDAO
{
	...
	public void restore()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "FencesDAO:restore()" );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement, rset);
		}
		_log.atInfo().log( "FencesDAO: restored %s fence(s).", restoredCount );
	}
	...
	public boolean insert(FenceInstance fence)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "FencesDAO:insert(fence)" );
			return false;
		}
		finally
		{
	...
	public boolean update(FenceInstance fence)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "FencesDAO:update(fence)" );
			return false;
		}
		finally
		{
	...
	public boolean delete(FenceInstance fence)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "FencesDAO:delete(fence)" );
			return false;
		}
		finally
		{
