...
public class CastleDAO
{
	...
	public void select(Castle castle)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CastleDAO.select(Castle):%s", e );
		}
		finally
		{
	...
	private void update0(Castle castle)
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CastleDAO#update0(Castle): %s", e );
		}
		finally
		{
