...
public class OlympiadParticipantsDAO
{
	...
	public void select()
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "OlympiadParticipantsDAO:select():" );
		}
		finally
		{
	...
	public void replace(int participantId)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "OlympiadParticipantsDAO:replace(int): %s", participantId );
		}
		finally
		{
	...
	public void delete(int participantId)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "OlympiadParticipantsDAO:delete(int): %s", participantId );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
