...
public class EffectsDAO
{
	...
	public void restoreEffects(Playable playable)
	{
		...
		try
		{
			...
			while(rset.next())
			{
				...
				final Abnormal abnormal = new Abnormal(playable, playable, skill, useType, false, true);
				...
				playable.getAbnormalList().add(abnormal, false);
			}
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Could not restore active effects data!" );
		}
		finally
		{
	...
	public void insert(Playable playable)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Could not store active effects data!" );
		}
		finally
		{
	...
	public void deleteBySkillId(int skillId)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Could not delete effects data by skillId!" );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
