...
public class SiegeClanDAO
{
		...
		try
		{
			...
			while(rset.next())
			{
				...
				if(object != null)
					...
					_log.atInfo().log( "SiegeClanDAO#load(Residence, String): null clan: %s; residence: %s", clanId, lazy(() -> residence.getId()) );
			}
		}
		catch(Exception e)
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SiegeClanDAO#load(Residence, String): %s", e );
		}
		finally
		{
	...
	public void insert(Residence residence, SiegeClanObject siegeClan)
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SiegeClanDAO#insert(Residence, SiegeClan): %s", e );
		}
		finally
		{
	...
	public void delete(Residence residence, SiegeClanObject siegeClan)
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SiegeClanDAO#delete(Residence, SiegeClan): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
	...
	public void delete(Residence residence)
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SiegeClanDAO#delete(Residence): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
	...
	public void update(Residence residence, SiegeClanObject siegeClan)
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "SiegeClanDAO#update(Residence, SiegeClan): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
