...
public class SummonsDAO
{
	...
	public List<RestoredSummon> restore(Player player)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Could not restore active summon data!" );
		}
		finally
		{
	...
	public void insert(SummonInstance summon)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Could not store active summon data!" );
		}
		finally
		{
