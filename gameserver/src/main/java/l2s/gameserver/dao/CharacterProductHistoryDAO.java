...
public class CharacterProductHistoryDAO
{
	...
	private static final CharacterProductHistoryDAO _instance;
	...
	{
		TIntObjectMap<ProductHistoryItem> map = new TIntObjectHashMap();
		Connection con = null;
	...
	static
	{
		_log = LoggerFactory.getLogger(CharacterProductHistoryDAO.class);
		_instance = new CharacterProductHistoryDAO();
	}
}
