...
public class ClanHallDAO
{
	...
	public void select(ClanHall clanHall)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "ClanHallDAO.select(ClanHall):%s", e );
		}
		finally
		{
	...
	private void update0(ClanHall c)
	{
		...
		{
			_log.atWarning().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "ClanHallDAO#update0(ClanHall): %s", e );
		}
		finally
		{
