...
public class CharacterDAO
{
	...
	private static final CharacterDAO _instance;
	...
	public String getAccountNameByObjectId(int objectId)
	{
		String result = null;
		Connection con = null;
		PreparedStatement statement = null;
		...
		{
			_log.error("CharNameTable.getAccountNameByObjectId(int): " + e, e);
		}
		finally
		{
			DbUtils.closeQuietly(con, statement, rset);
	...
	static
	{
		_log = LoggerFactory.getLogger(CharacterDAO.class);
