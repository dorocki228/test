...
public class CharacterBlockListDAO
{
	...
	private static final CharacterBlockListDAO _instance;
	...
	{
		TIntObjectMap<Block> map = new TIntObjectHashMap();
		Connection con = null;
	...
	static
	{
		_log = LoggerFactory.getLogger(CharacterBlockListDAO.class);
		_instance = new CharacterBlockListDAO();
	}
}
