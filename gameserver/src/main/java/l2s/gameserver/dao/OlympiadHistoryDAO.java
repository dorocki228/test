...
public class OlympiadHistoryDAO
{
	...
	public Map<Boolean, List<OlympiadHistory>> select()
	{
		...
		catch(Exception e)
		{
			...
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "OlympiadHistoryDAO: select(): %s", e );
		}
		finally
		{
	...
	public void insert(OlympiadHistory history)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "OlympiadHistoryDAO: insert(OlympiadHistory): %s", e );
		}
		finally
		{
