...
public class CharacterSubclassDAO
{
	...
	public boolean insert(int objId, int classId, long exp, long sp, double curHp, double curMp, double curCp, double maxHp, double maxMp, double maxCp, int level, boolean active, SubClassType type, ElementalElement activeElement)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterSubclassDAO:insert(player)" );
			return false;
		}
		finally
		{
	...
	public List<SubClass> restore(Player player)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterSubclassDAO:restore(player)" );
		}
		finally
		{
	...
	public boolean store(Player player)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterSubclassDAO:store(player)" );
			return false;
		}
		finally
		{
