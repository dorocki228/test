...
public class PremiumAccountDAO
{
	...
	public int[] select(String account)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "PremiumAccountDAO.select(String): %s", e );
		}
		finally
		{
	...
	public void delete(String account)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "PremiumAccountDAO.delete(String): %s", e );
		}
		finally
		{
	...
	public void insert(String account, int bonus, int endTime)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "PremiumAccountDAO.insert(String, double, int): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
