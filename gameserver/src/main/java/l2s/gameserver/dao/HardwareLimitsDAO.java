...
public class HardwareLimitsDAO
{
	...
	public int[] select(String hardware)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "HardwareLimitsDAO.select(String): %s", e );
		}
		finally
		{
	...
	public void delete(String hardware)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "HardwareLimitsDAO.delete(String): %s", e );
		}
		finally
		{
	...
	public void insert(String hardware, int limit, int expire)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "HardwareLimitsDAO.insert(String, int): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
