...
public class ItemsEnsoulDAO
{
	...
	public void restore(ItemInstance item)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "ItemsEnsoulDAO.restore(int): %s", e );
		}
		finally
		{
	...
	public void delete(int objectId, int type, int id)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "ItemsEnsoulDAO.delete(int,int,int): %s", e );
		}
		finally
		{
	...
	public void delete(int objectId)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "ItemsEnsoulDAO.delete(int): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
	...
	public void insert(int objectId, int type, int id, int ensoulId)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "ItemsEnsoulDAO.insert(int,int,int,int): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
