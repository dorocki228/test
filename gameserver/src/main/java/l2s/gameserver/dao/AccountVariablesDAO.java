...
public class AccountVariablesDAO
{
	...
	public String select(String account, String var, String defaultVal)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "AccountVariablesDAO.select(String, String): %s", e );
		}
		finally
		{
	...
	public void delete(String account, String var)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "AccountVariablesDAO.delete(String, String): %s", e );
		}
		finally
		{
	...
	public void delete(String var)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "AccountVariablesDAO.delete(String): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
	...
	public void insert(String account, String var, Object value)
	{
		...
		{
			_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "AccountVariablesDAO.insert(String, String, String): %s", e );
		}
		finally
		{
			DbUtils.closeQuietly(con, statement);
