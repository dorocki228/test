...
public class CharacterCostumesDAO {
	...
	public void restore(Player owner, Map<Integer, Costume> costumes, Map<Integer, Integer> shortcuts) {
		...
		try {
			...
			LOGGER.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterCostumesDAO.select(Player,Map): %s", e );
		} finally {
	...
	public boolean store(Player owner) {
		...
		try {
			...
			LOGGER.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterCostumesDAO.store(Player): %s", e );
			return false;
		} finally {
	...
	public boolean insert(Player owner, Costume costume) {
		...
		try {
			...
			LOGGER.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterCostumesDAO.insert(Player,Costume): %s", e );
			return false;
		} finally {
			DbUtils.closeQuietly(con, statement);
		}
	...
	public boolean update(Player owner, Costume costume) {
		...
		try {
			...
			LOGGER.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterCostumesDAO.update(Player,Costume): %s", e );
			return false;
		} finally {
			DbUtils.closeQuietly(con, statement);
		}
	...
	public boolean delete(Player owner, int costumeId) {
		...
		try {
			...
			LOGGER.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "CharacterCostumesDAO.delete(Player,int): %s", e );
			return false;
		} finally {
			DbUtils.closeQuietly(con, statement);
		}
