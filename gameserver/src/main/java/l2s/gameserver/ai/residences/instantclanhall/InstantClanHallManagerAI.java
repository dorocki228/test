package l2s.gameserver.ai.residences.instantclanhall;
...
public class InstantClanHallManagerAI extends NpcAI
{
	...
	private static final Location[] teleport_loc = {
			new Location(-14520, 122481, -3112),
			new Location(-13068, 123698, -3112),
			new Location(-15519, 124018, -3120) };
	...
	protected void onEvtTimer(int timerId, Object arg1, Object arg2)
	{
		...
		else if(timerId == teleport_timer)
		{
			if(arg1 != null && (arg1 instanceof Player))
				((Player) arg1).teleToLocation(teleport_loc[Rnd.get(teleport_loc.length)], ReflectionManager.MAIN);
		}
	}
}