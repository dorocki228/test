...
public abstract class AbstractAI<T extends Creature> implements Runnable
{
	public static final Object[] EMPTY_OBJECTS_ARRAY = {};
	...
	public void setIntention(CtrlIntention intention, Object arg0, Object arg1)
	{
		...
		if (actor.isAfraid()) {
			p_fear.Companion.runInFear(null, actor);
			return;
		}
	...
	{
		notifyEvent(evt, EMPTY_OBJECTS_ARRAY);
	}
	...
	public void notifyEvent(CtrlEvent evt, Object[] args)
	{
		...
		switch(evt)
		{
			...
			case EVT_FORGET_OBJECT:
				...
				break;
			case EVT_DEAD:
				onEvtDead((Creature) args[0], (LostItems) args[1]);
				break;
			case EVT_FAKE_DEATH:
				onEvtFakeDeath();
				break;
	...
	protected abstract void onEvtDead(Creature killer, LostItems lostItems);
