...
public enum DetectionResponse
{
	...
	DetectionResponse(final int response, final String description)
	{
	...
	public static DetectionResponse valueOf(final int id)
	{
		for(final DetectionResponse detectionResponse : values())
		{
