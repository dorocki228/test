...
public class Account
{
	...
	private final Map<Integer, Pair<Integer, int[]>> _serversInfo;

	public Account(String login)
	{
		allowedIpList = new NetList();
		_serversInfo = new HashMap<>(2);
		this.login = login;
	}
	...
	public void restore()
	{
		...
		try
		{
			...
			statement = con.prepareStatement("SELECT password, access_level, ban_expire, allow_ip, allow_hwid," +
					"bonus, bonus_expire, last_server, last_ip, last_access, points, source FROM accounts WHERE login = ?");
