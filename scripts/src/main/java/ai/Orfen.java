...
public class Orfen extends Fighter<OrfenInstance>
{
	...
	public Orfen(OrfenInstance actor)
	{
		super(actor);
		_paralyze = getActor().getTemplate().getAISkills(AISkillScope.COT).toArray(Skill.EMPTY_ARRAY);
	}
