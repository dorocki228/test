 ...
 */
public class ArtefactAI extends NpcAI<NpcInstance>
{
	...
	class notifyGuard implements Runnable
	{
		...
		public void run()
		{
			...
			if(skillEntry != null && (skillEntry.getTemplate().getTargetTypeNew() == TargetType.HOLYTHING || (skillEntry.getTemplate().getTargetType() == Skill.SkillTargetType.TARGET_HOLY)))
