...
import l2s.gameserver.network.l2.c2s.RequestExOlympiadMatchListRefresh;
import l2s.gameserver.network.l2.components.CustomMessage;
import l2s.gameserver.network.l2.components.HtmlMessage;
import l2s.gameserver.network.l2.components.SystemMsg;
import l2s.gameserver.network.l2.s2c.ExGFXOlympiad;
import l2s.gameserver.network.l2.s2c.ExGFXOlympiad.MatchList.ArenaInfo;
...
public class CustomObservationManagerInstance extends NpcInstance
{
	...
	private static void showMatchList(Player player)
	{
		...
		player.sendPacket(new ExGFXOlympiad.MatchList(arenaList));
	}
	...
	{
		if(packet == RequestExOlympiadMatchListRefresh.class)
		{
			showMatchList(player);
			return true;
		}
