...
public class WarehouseInstance extends NpcInstance
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		{
			String messagePattern = "Player {} trying to use enchant exploit[CastleWarehouse], ban this player!";
			ParameterizedMessage message = new ParameterizedMessage(messagePattern, player);
		...
		else if("ExchangeBloodAlli".equalsIgnoreCase(command))
		{
			if(!player.isClanLeader())
			{
				HtmlMessage html = new HtmlMessage(this);
		...
		else if("ReciveBloodAlli".equalsIgnoreCase(command))
		{
