...
public class Security extends ScriptVoiceCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player activeChar, String target)
	{
		...
		else if(command.equalsIgnoreCase("lockHwid"))
		{
			...
			GameServer.getInstance().getAuthServerCommunication().sendPacket(new ChangeAllowedHwid(activeChar.getAccountName(), activeChar.getNetConnection().getHWID()));
			HtmlMessage html = new HtmlMessage(activeChar.getObjectId());
			...
			GameServer.getInstance().getAuthServerCommunication().sendPacket(new ChangeAllowedIp(activeChar.getAccountName(), ""));
			...
			GameServer.getInstance().getAuthServerCommunication().sendPacket(new ChangeAllowedHwid(activeChar.getAccountName(), ""));
