...
public class OnShiftAction_NpcInstance extends ScriptOnShiftActionHandler<NpcInstance>
{
	...
	public void resists(Player player, NpcInstance npc, String[] par)
	{
		...
		hasResist = addResist(dialog, "Fire", npc.getStat().getValue(DoubleStat.DEFENCE_FIRE, 0));
		hasResist |= addResist(dialog, "Wind", npc.getStat().getValue(DoubleStat.DEFENCE_WIND, 0));
		hasResist |= addResist(dialog, "Water", npc.getStat().getValue(DoubleStat.DEFENCE_WATER, 0));
		hasResist |= addResist(dialog, "Earth", npc.getStat().getValue(DoubleStat.DEFENCE_EARTH, 0));
		hasResist |= addResist(dialog, "Light", npc.getStat().getValue(DoubleStat.DEFENCE_HOLY, 0));
		hasResist |= addResist(dialog, "Darkness", npc.getStat().getValue(DoubleStat.DEFENCE_UNHOLY, 0));
		/*hasResist |= addResist(dialog, "Bleed", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_BLEED));
		hasResist |= addResist(dialog, "Poison", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_POISON));
		hasResist |= addResist(dialog, "Stun", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_SHOCK));
		hasResist |= addResist(dialog, "Root", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_HOLD));
		hasResist |= addResist(dialog, "Sleep", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_SLEEP));
		hasResist |= addResist(dialog, "Paralyze", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_PARALYZE));
		hasResist |= addResist(dialog, "Mental", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_DERANGEMENT));*/
		hasResist |= addResist(dialog, "Debuff", npc.getStat().getValue(DoubleStat.RESIST_ABNORMAL_DEBUFF, 0));
		/*hasResist |= addResist(dialog, "Cancel", npc.getStat().getValue(DoubleStat.CANCEL_RESIST, 0));
		hasResist |= addResist(dialog, "Sword", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_SWORD));
		hasResist |= addResist(dialog, "Dual Sword", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_DUAL));
		hasResist |= addResist(dialog, "Blunt", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_BLUNT));
		hasResist |= addResist(dialog, "Dagger", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_DAGGER));
		hasResist |= addResist(dialog, "Bow", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_BOW));
		hasResist |= addResist(dialog, "Crossbow", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_CROSSBOW));
		hasResist |= addResist(dialog, "2H Crossbow", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_TWOHANDCROSSBOW));
		hasResist |= addResist(dialog, "Polearm", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_POLE));
		hasResist |= addResist(dialog, "Fist", npc.getStat().getValue(DoubleStat.DEFENCE_TRAIT_FIST));*/
