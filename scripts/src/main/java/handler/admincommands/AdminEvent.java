...
public class AdminEvent extends ScriptAdminCommand
{
	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(c)
		{
			...
			case admin_stop_event:
				...
				try
				{
					boolean pvp = "pvp".equalsIgnoreCase(wordList[1]);
	...
	{
		HashMap<Integer, String> tpls = HtmCache.getInstance().getTemplates("admin/events/events.htm", activeChar);

		String html = tpls.get(0);

		String eventBlock = tpls.get(1);
		String startButton = tpls.get(2);
		String stopButton = tpls.get(3);
		...
		String startPvPButton = tpls.get(4);
		String stopPvPButton = tpls.get(5);
