	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player player)
	{
		...
		switch(c)
		{
			case admin_setskill:
				...
				{
					_log.atInfo().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "AdminClientSupport:useAdminCommand(Enum,String[],String,L2Player): %s", e );
					return false;
				}
				break;
			case admin_summon:
