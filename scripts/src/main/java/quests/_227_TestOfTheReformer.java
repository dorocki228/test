...
public final class _227_TestOfTheReformer extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if("preacher_sla_q0227_04.htm".equalsIgnoreCase(event))
		{
		...
		else if("Wait2".equalsIgnoreCase(event))
		{
		...
		else if("Wait3".equalsIgnoreCase(event))
		{
		...
		else if("Wait4".equalsIgnoreCase(event))
		{
		...
		else if("Wait5".equalsIgnoreCase(event))
		{
