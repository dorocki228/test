...
public final class _369_CollectorOfJewels extends Quest
{
	...
	// Quest Items
	private static final int SOUL_SHARD = 49054;
	...
	public _369_CollectorOfJewels()
	{
		...
		DROPLIST.put(Roxide, new int[] { SOUL_SHARD, 85 });
		DROPLIST.put(Rowin_Undine, new int[] { SOUL_SHARD, 73 });
		DROPLIST.put(Lakin_Undine, new int[] { SOUL_SHARD, 60 });
		DROPLIST.put(Salamander_Rowin, new int[] { SOUL_SHARD, 77 });
		DROPLIST.put(Lakin_Salamander, new int[] { SOUL_SHARD, 77 });
		DROPLIST.put(Death_Fire, new int[] { SOUL_SHARD, 85 });
