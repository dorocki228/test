...
public final class _213_TrialOfSeeker extends Quest
{
	...
	private static final int[][] DROPLIST_COND = {
			...
			{ 15, 0, MarshStakatoDrone, ListOfHost, AbyssRunestone1, 1, 25, 1 },
			{ 15, 0, BrekaOrcOverlord, ListOfHost, AbyssRunestone2, 1, 25, 1 },
			{ 15, 0, AntWarriorCaptain, ListOfHost, AbyssRunestone3, 1, 25, 1 },
			{ 15, 0, LetoLizardmanWarrior, ListOfHost, AbyssRunestone4, 1, 25, 1 } };
	...
	{
		if(st.getQuestItemsCount(MarkofSeeker) > 0){ return COMPLETED_DIALOG; }
