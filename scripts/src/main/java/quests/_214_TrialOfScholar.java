...
public final class _214_TrialOfScholar extends Quest
{
	...
	{
		if("magister_mirien_q0214_04.htm".equalsIgnoreCase(event))
		{
			st.giveItems(Miriens_1st_Sigil, 1);
			st.setCond(1);
		}
		else if("sylvain_q0214_02.htm".equalsIgnoreCase(event))
		{
			st.giveItems(High_Priests_Sigil, 1);
			st.giveItems(Sylvains_Letter, 1);
			st.setCond(2);
		}
		else if("marya_q0214_02.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Sylvains_Letter, -1);
			st.giveItems(Marias_1st_Letter, 1);
			st.setCond(3);
		}
		else if("astrologer_creta_q0214_05.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Marias_2nd_Letter, -1);
			st.giveItems(Cretas_1st_Letter, 1);
			st.setCond(6);
		}
		else if("marya_q0214_08.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Cretas_1st_Letter, -1);
			st.giveItems(Lucillas_Handbag, 1);
			st.setCond(7);
		}
		else if("astrologer_creta_q0214_09.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Lucillas_Handbag, -1);
			st.giveItems(Cretas_Painting1, 1);
			st.setCond(8);
		}
		else if("lucas_q0214_04.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Cretas_Painting2, -1);
			st.giveItems(Cretas_Painting3, 1);
			st.setCond(10);
		}
		else if("marya_q0214_14.htm".equalsIgnoreCase(event))
		{
		...
		else if("valkon_q0214_04.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(Valkons_Request) == 0)
		{
			st.playSound(SOUND_MIDDLE);
			st.giveItems(Valkons_Request, 1);
		}
		else if("jurek_q0214_03.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(Grand_Magisters_Sigil) == 0 && st.getQuestItemsCount(Symbol_of_Jurek) == 0)
		{
			st.giveItems(Grand_Magisters_Sigil, 1);
			st.giveItems(Jureks_List, 1);
			st.setCond(16);
		}
		else if("magister_mirien_q0214_10.htm".equalsIgnoreCase(event))
		{
		...
		else if("sage_cronos_q0214_10.htm".equalsIgnoreCase(event))
		{
			st.giveItems(Cronos_Sigil, 1);
			st.giveItems(Cronos_Letter, 1);
			st.setCond(20);
		}
		else if("dieter_q0214_05.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Cronos_Letter, -1);
			st.giveItems(Dieters_Key, 1);
			st.setCond(21);
		}
		else if("astrologer_creta_q0214_14.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Dieters_Key, -1);
			st.giveItems(Cretas_2nd_Letter, 1);
			st.setCond(22);
		}
		else if("dieter_q0214_09.htm".equalsIgnoreCase(event))
		{
		...
		else if("trader_edroc_q0214_02.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Dieters_Letter, -1);
			st.giveItems(Rauts_Letter_Envelope, 1);
			st.setCond(24);
		}
		else if("warehouse_keeper_raut_q0214_02.htm".equalsIgnoreCase(event))
		{
		...
		else if("drunkard_treaf_q0214_04.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Strong_Liquor, -1);
			st.giveItems(Triffs_Ring, 1);
			st.setCond(26);
		}
		else if("sage_kasian_q0214_04.htm".equalsIgnoreCase(event))
		{
			if(st.getQuestItemsCount(Casians_List) == 0)
				st.giveItems(Casians_List, 1);
			st.setCond(28);
		}
		else if("sage_kasian_q0214_07.htm".equalsIgnoreCase(event))
		{
		...
		else if("sage_cronos_q0214_14.htm".equalsIgnoreCase(event))
		{
	...
	{
		if(st.getQuestItemsCount(Mark_of_Scholar) > 0){ return COMPLETED_DIALOG; }
