...
public final class _327_ReclaimTheLand extends Quest
{
	...
	{
		if("piotur_q0327_03.htm".equalsIgnoreCase(event))
		{
			st.setCond(1);
		}
		else if("piotur_q0327_06.htm".equalsIgnoreCase(event))
		{
			st.finishQuest();
		}
		else if("trader_acellopy_q0327_02.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(CLAY_URN_FRAGMENT) >= 5)
		{
		...
		else if("trader_acellopy_q0327_04.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(BRASS_TRINKET_PIECE) >= 5)
		{
		...
		else if("trader_acellopy_q0327_06.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(BRONZE_MIRROR_PIECE) >= 5)
		{
		...
		else if("trader_acellopy_q0327_08.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(JADE_NECKLACE_BEAD) >= 5)
		{
