...
public final class _223_TestOfChampion extends Quest
{
	...
	private static final int[][] DROPLIST = {
			...
			{ COND2, COND3, BloodyAxeElite, BLOODY_AXE_HEAD, 20, 10 },
			{ COND6, COND7, Harpy, HARPYS_EGG, 100, 30 },
			{ COND6, COND7, HarpyMatriarch, HARPYS_EGG, 100, 30 },
			{ COND6, COND7, Medusa, MEDUSA_VENOM, 50, 30 },
			{ COND6, COND7, Windsus, WINDSUS_BILE, 50, 30 },
			{ COND10, COND11, RoadScavenger, ROAD_RATMAN_HEAD, 20, 10 },
			{ COND12, COND13, LetoLizardman, LETO_LIZARDMAN_FANG, 20, 10 },
			{ COND12, COND13, LetoLizardmanArcher, LETO_LIZARDMAN_FANG, 22, 10 },
			{ COND12, COND13, LetoLizardmanSoldier, LETO_LIZARDMAN_FANG, 24, 10 },
			{ COND12, COND13, LetoLizardmanWarrior, LETO_LIZARDMAN_FANG, 26, 10 },
			{ COND12, COND13, LetoLizardmanShaman, LETO_LIZARDMAN_FANG, 28, 10 },
			{ COND12, COND13, LetoLizardmanOverlord, LETO_LIZARDMAN_FANG, 30, 10 }, };
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if("30624_1".equals(event))
			htmltext = "veteran_ascalon_q0223_05.htm";
		else if("30624_2".equals(event))
		{
		...
		else if("30625_1".equals(event))
			htmltext = "mason_q0223_02.htm";
		else if("30625_2".equals(event))
		{
		...
		else if("30196_1".equals(event))
			htmltext = "mouen_q0223_02.htm";
		else if("30196_2".equals(event))
		{
	...
	{
		if(st.getQuestItemsCount(MARK_OF_CHAMPION) > 0){ return COMPLETED_DIALOG; }
