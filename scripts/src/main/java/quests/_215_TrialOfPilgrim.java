...
public final class _215_TrialOfPilgrim extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if("hermit_santiago_q0215_04.htm".equals(event))
		{
			st.setCond(1);
			st.giveItems(VOUCHER_OF_TRIAL_ID, 1);
		}
		else if("ancestor_martankus_q0215_04.htm".equals(event))
		{
			st.setCond(5);
			st.giveItems(SPIRIT_OF_FLAME_ID, 1);
			st.takeItems(ESSENSE_OF_FLAME_ID, 1);
		}
		else if("gerald_priest_of_earth_q0215_02.htm".equals(event))
		{
		...
		else if("andellria_q0215_05.htm".equals(event))
		{
			st.setCond(16);
			st.takeItems(BOOK_OF_DARKNESS_ID, 1);
		}
		else if("andellria_q0215_04.htm".equals(event))
			st.setCond(16);
		else if("uruha_q0215_02.htm".equals(event))
		{
			st.setCond(15);
