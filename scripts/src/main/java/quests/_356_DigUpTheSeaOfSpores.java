...
public class _356_DigUpTheSeaOfSpores extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
        if("magister_gauen_q0356_06.htm".equalsIgnoreCase(event))
			st.setCond(1);
		else if("magister_gauen_q0356_11.htm".equalsIgnoreCase(event) || "magister_gauen_q0356_13.htm".equalsIgnoreCase(event))
		{
			if(st.haveQuestItem(CARNIVORE_SPORE, 100) && st.haveQuestItem(HERBIBOROUS_SPORE, 100))
			{
				...
				if("magister_gauen_q0356_11.htm".equalsIgnoreCase(event))
