...
public final class _273_InvadersOfHolyland extends Quest
{
	...
	{
        if("atuba_chief_varkees_q0273_03.htm".equals(event))
		{
			st.setCond(1);
		}
		else if("atuba_chief_varkees_q0273_07.htm".equals(event))
		{
			st.finishQuest();
		}
		else if("atuba_chief_varkees_q0273_08.htm".equals(event))
		{
			st.setCond(1);
		}
		return event;
