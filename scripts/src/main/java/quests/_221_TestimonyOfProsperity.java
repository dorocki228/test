...
public final class _221_TestimonyOfProsperity extends Quest
{
	...
	private static final int[][] DROPLIST_COND = {
			...
			{ 7, 0, MarshStakato, 0, StakatoShell, 20, 100, 1 },
			{ 7, 0, MarshStakatoWorker, 0, StakatoShell, 20, 100, 1 },
			{ 7, 0, MarshStakatoSoldier, 0, StakatoShell, 20, 100, 1 },
			{ 7, 0, MarshStakatoDrone, 0, StakatoShell, 20, 100, 1 },
			{ 7, 0, ToadLord, 0, ToadLordSac, 10, 100, 1 },
			{ 7, 0, MarshSpider, 0, SpiderThorn, 10, 100, 1 } };
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if("parman_q0221_04.htm".equalsIgnoreCase(event))
		{
			st.giveItems(RingOfTestimony1st, 1);
			st.setCond(1);
		}
		else if("guard_bright_q0221_03.htm".equalsIgnoreCase(event))
			st.giveItems(BrightsList, 1);
		else if("emilly_q0221_03.htm".equalsIgnoreCase(event))
		{
		...
		else if("piotur_q0221_02.htm".equalsIgnoreCase(event))
		{
		...
		else if("wilph_q0221_04.htm".equalsIgnoreCase(event))
			st.giveItems(CrystalBrooch, 1);
		else if("rylith_q0221_03.htm".equalsIgnoreCase(event))
		{
		...
		else if("first_elder_lockirin_q0221_03.htm".equalsIgnoreCase(event))
		{
		...
		else if("carrier_torocco_q0221_02.htm".equalsIgnoreCase(event))
			st.giveItems(ProcurationOfTorocco, 1);
		else if("elder_keef_q0221_03a.htm".equalsIgnoreCase(event) && st.getQuestItemsCount(ADENA_ID) >= 5000)
		{
		...
		else if("parman_q0221_07.htm".equalsIgnoreCase(event))
		{
		...
		else if("maestro_nikola_q0221_04.htm".equalsIgnoreCase(event))
		{
			st.giveItems(ClayDough, 1);
			st.setCond(5);
		}
		else if("box_of_titan_q0221_02.htm".equalsIgnoreCase(event))
		{
			st.takeItems(ClayDough, -1);
			st.giveItems(PatternOfKeyhole, 1);
			st.setCond(6);
		}
		else if("box_of_titan_q0221_04.htm".equalsIgnoreCase(event))
		{
	...
	{
		if(st.getQuestItemsCount(MarkOfProsperity) != 0){ return COMPLETED_DIALOG; }
