...
public final class _216_TrialoftheGuildsman extends Quest
{
	...
	private static final int[][] DROPLIST_COND = {
			...
			{ 5, 0, 20267, DUNINGS_INSTRUCTIONS, DUNINGS_KEY, 30, 100, 1 },
			{ 5, 0, 20268, DUNINGS_INSTRUCTIONS, DUNINGS_KEY, 30, 100, 1 },
			{ 5, 0, 20269, DUNINGS_INSTRUCTIONS, DUNINGS_KEY, 30, 100, 1 },
			{ 5, 0, 20270, DUNINGS_INSTRUCTIONS, DUNINGS_KEY, 30, 100, 1 },
			{ 5, 0, 20271, DUNINGS_INSTRUCTIONS, DUNINGS_KEY, 30, 100, 1 },
	...
	{
		if(st.getQuestItemsCount(MARK_OF_GUILDSMAN) > 0){ return COMPLETED_DIALOG; }
