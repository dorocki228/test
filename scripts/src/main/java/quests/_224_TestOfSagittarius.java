...
public final class _224_TestOfSagittarius extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if("30626_1".equals(event))
			htmltext = "sagittarius_hamil_q0224_02.htm";
		else if("30626_2".equals(event))
		{
		...
		else if("30626_3".equals(event))
			htmltext = "sagittarius_hamil_q0224_06.htm";
		else if("30626_4".equals(event))
		{
	...
	{
		if(st.getQuestItemsCount(MARK_OF_SAGITTARIUS_ID) > 0){ return COMPLETED_DIALOG; }
