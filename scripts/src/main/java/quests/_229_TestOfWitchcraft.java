...
public final class _229_TestOfWitchcraft extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if("orim_the_shadow_q0229_08.htm".equalsIgnoreCase(event))
		{
			st.giveItems(OrimsDiagram, 1);
			st.setCond(1);
		}
		else if("alexandria_q0229_03.htm".equalsIgnoreCase(event))
		{
			st.giveItems(AlexandriasBook, 1);
			st.takeItems(OrimsDiagram, 1);
			st.setCond(2);
		}
		else if("iker_q0229_03.htm".equalsIgnoreCase(event))
			st.giveItems(IkersList, 1);
		else if("magister_kaira_q0229_02.htm".equalsIgnoreCase(event))
			st.giveItems(Aklantoth_2stGem, 1);
		else if("lars_q0229_02.htm".equalsIgnoreCase(event))
			st.giveItems(LarasMemo, 1);
		else if("trader_nestle_q0229_02.htm".equalsIgnoreCase(event))
			st.giveItems(NestlesMemo, 1);
		else if("leopold_q0229_02.htm".equalsIgnoreCase(event))
		{
			st.takeItems(NestlesMemo, 1);
			st.giveItems(LeopoldsJournal, 1);
		}
		else if("orim_the_shadow_q0229_14.htm".equalsIgnoreCase(event))
		{
		...
		else if("orim_the_shadow_q0229_16.htm".equalsIgnoreCase(event))
		{
		...
		else if("iker_q0229_08.htm".equalsIgnoreCase(event))
		{
		...
		else if("sir_karrel_vasper_q0229_03.htm".equalsIgnoreCase(event))
		{
			st.takeItems(Orims1stLetter, 1);
			st.giveItems(SirVaspersLetter, 1);
		}
		else if("fisher_evert_q0229_02.htm".equalsIgnoreCase(event))
		{
			NpcInstance isQuest = GameObjectsStorage.getByNpcId(DrevanulPrinceZeruel);
			if(isQuest != null)
		...
		else if("orim_the_shadow_q0229_20.htm".equalsIgnoreCase(event))
			st.takeItems(ZeruelBindCrystal, 1);
		else if("orim_the_shadow_q0229_21.htm".equalsIgnoreCase(event))
			st.takeItems(PurgatoryKey, 1);
		else if("orim_the_shadow_q0229_22.htm".equalsIgnoreCase(event))
		{
	...
	{
		if(st.getQuestItemsCount(MarkOfWitchcraft) != 0){ return COMPLETED_DIALOG; }
