...
public final class _230_TestOfSummoner extends Quest
{
	...
	static int[][] SUMMONERS = {
			{ 30635, ALMORS_ARCANA_ID, CRYSTAL_OF_VICTORY1_ID },
			// Almors
			{ 30636, CAMONIELL_ARCANA_ID, CRYSTAL_OF_VICTORY2_ID },
			// Camoniell
			{ 30637, BELTHUS_ARCANA_ID, CRYSTAL_OF_VICTORY3_ID },
			// Belthus
			{ 30638, BASILLIA_ARCANA_ID, CRYSTAL_OF_VICTORY4_ID },
			// Basilla
			{ 30639, CELESTIEL_ARCANA_ID, CRYSTAL_OF_VICTORY5_ID },
			// Celestiel
			{ 30640, BRYNTHEA_ARCANA_ID, CRYSTAL_OF_VICTORY6_ID }
			// Brynthea
	};
	...
	static String[] STATS = { "step", "Lara_Part", "Arcanas", "Belthus", "Brynthea", "Celestiel", "Camoniell", "Basilla", "Almors" };

	static int[][] LISTS = {
			{},
			// zero element filler
			{ LARS_LIST1_ID, SAC_OF_REDSPORES_ID, LETOLIZARDMAN_AMULET_ID },
			// List 1
			{ LARS_LIST2_ID, KARULBUGBEAR_TOTEM_ID, SHARDS_OF_MANASHEN_ID },
			// List 2
			{ LARS_LIST3_ID, CRIMSON_BLOODSTONE_ID, BREKAORC_TOTEM_ID },
			// List 3
			{ LARS_LIST4_ID, TUSK_OF_WINDSUS_ID, TALONS_OF_TYRANT_ID },
			// List 4
			{ LARS_LIST5_ID, WINGS_OF_DRONEANT_ID, FANGS_OF_WYRM_ID }
			// List 5
	};
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if("high_summoner_galatea_q0230_08.htm".equalsIgnoreCase(event))
		...
		else if("high_summoner_galatea_q0230_07.htm".equalsIgnoreCase(event))
			st.giveItems(GALATEAS_LETTER_ID, 1);
		else if("lars_q0230_02.htm".equalsIgnoreCase(event))
		...
		else if("30063_2".equalsIgnoreCase(event))
		...
		else if("lars_q0230_04.htm".equalsIgnoreCase(event))
		{ // Lara later to give a list out
			int random = Rnd.get(5) + 1;
			st.giveItems(LISTS[random][0], 1);
			st.set("Lara_Part", str(random));
		}
		else if("summoner_almors_q0230_02.htm".equalsIgnoreCase(event))
		...
		else if("summoner_almors_q0230_04.htm".equalsIgnoreCase(event))
		{
		...
		else if("summoner_camoniell_q0230_02.htm".equalsIgnoreCase(event))
		{ // Camoniell's Part
			if(st.getQuestItemsCount(BEGINNERS_ARCANA_ID) > 0)
			{
		...
		else if("summoner_camoniell_q0230_04.htm".equalsIgnoreCase(event))
		{
		...
		else if("summoner_belthus_q0230_02.htm".equalsIgnoreCase(event))
		{ // Belthus' Part
			if(st.getQuestItemsCount(BEGINNERS_ARCANA_ID) > 0)
			{
		...
		else if("summoner_belthus_q0230_04.htm".equalsIgnoreCase(event))
		{
		...
		else if("summoner_basillia_q0230_02.htm".equalsIgnoreCase(event))
		{ // Basilla's Part
			if(st.getQuestItemsCount(BEGINNERS_ARCANA_ID) > 0)
			{
		...
		else if("summoner_basillia_q0230_04.htm".equalsIgnoreCase(event))
		{
		...
		else if("summoner_celestiel_q0230_02.htm".equalsIgnoreCase(event))
		{ // Celestiel's Part
			if(st.getQuestItemsCount(BEGINNERS_ARCANA_ID) > 0)
			{
		...
		else if("summoner_celestiel_q0230_04.htm".equalsIgnoreCase(event))
		{
		...
		else if("summoner_brynthea_q0230_02.htm".equalsIgnoreCase(event))
		{ // Brynthea's Part
			if(st.getQuestItemsCount(BEGINNERS_ARCANA_ID) > 0)
			{
		...
		else if("summoner_brynthea_q0230_04.htm".equalsIgnoreCase(event))
		{
