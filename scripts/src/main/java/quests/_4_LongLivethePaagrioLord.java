...
public final class _4_LongLivethePaagrioLord extends Quest
{
	...
	public _4_LongLivethePaagrioLord()
	{
		...
		addLevelCheck("centurion_nakusin_q0004_01.htm", 2, 5);
		addRaceCheck("centurion_nakusin_q0004_00.htm", Race.ORC);
	}

	@Override
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
        if("centurion_nakusin_q0004_03.htm".equalsIgnoreCase(event))
			st.setCond(1);
		return event;
	}
