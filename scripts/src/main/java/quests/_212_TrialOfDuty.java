...
public final class _212_TrialOfDuty extends Quest
{
	...
	public _212_TrialOfDuty()
	{
		...
		addClassIdCheck("hannavalt_q0212_02.htm", 4, 19, 32);
		addLevelCheck("hannavalt_q0212_01.htm", 35);
	}
	...
	{
		if(st.getQuestItemsCount(MARK_OF_DUTY_ID) > 0){ return COMPLETED_DIALOG; }
