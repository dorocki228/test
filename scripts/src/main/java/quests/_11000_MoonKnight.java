...
public class _11000_MoonKnight extends Quest
{
	...
	{
        if("30939-03.htm".equalsIgnoreCase(event))
		{
			st.setCond(1);
		}
		else if("30939-05.htm".equalsIgnoreCase(event))
		{
			st.setCond(5);
		}
		else if("30939-07.htm".equalsIgnoreCase(event))
		{
			st.setCond(6);
		}
		else if("30437-03.htm".equalsIgnoreCase(event))
		{
			st.setCond(8);
		}
		else if("30941-04.htm".equalsIgnoreCase(event))
		{
			st.setCond(9);
		}
		else if("light".equalsIgnoreCase(event))
		{
		...
		else if("heavy".equalsIgnoreCase(event))
		{
			st.giveItems(7850, 1, false);
		...
		else if("magic".equalsIgnoreCase(event))
		{
			st.giveItems(7850, 1, false);
