...
public final class _412_PathToDarkwizard extends Quest
{
	...
	public final int[][] DROPLIST = {
			{ MARSH_ZOMBIE, LUCKY_KEY_ID, FAMILYS_ASHES_ID, 3 },
			{ MARSH_ZOMBIE_LORD, LUCKY_KEY_ID, FAMILYS_ASHES_ID, 3 },
			{ SKELETON_HUNTER, CANDLE_ID, KNEE_BONE_ID, 2 },
			{ SKELETON_HUNTER_ARCHER, CANDLE_ID, KNEE_BONE_ID, 2 },
			{ MISERY_SKELETON, CANDLE_ID, KNEE_BONE_ID, 2 },
			{ SKELETON_SCOUT, HUB_SCENT_ID, HEART_OF_LUNACY_ID, 3 } };
