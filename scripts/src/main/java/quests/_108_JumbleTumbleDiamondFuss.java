...
public final class _108_JumbleTumbleDiamondFuss extends Quest
{
	...
	public _108_JumbleTumbleDiamondFuss()
	{
		...
		addLevelCheck("collector_gouph_q0108_01.htm", 10, 14);
		addRaceCheck("collector_gouph_q0108_00.htm", Race.DWARF);
	}

	@Override
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
        if("collector_gouph_q0108_03.htm".equals(event))
		{
			st.setCond(1);
			st.giveItems(GOUPHS_CONTRACT, 1);
		}
		else if("carrier_torocco_q0108_02.htm".equals(event))
		{
			st.takeItems(REEPS_CONTRACT, 1);
			st.giveItems(ELVEN_WINE, 1);
			st.setCond(3);
		}
		else if("blacksmith_bronp_q0108_02.htm".equals(event))
		{
