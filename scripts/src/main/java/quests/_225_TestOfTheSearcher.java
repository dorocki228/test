...
public final class _225_TestOfTheSearcher extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if("master_luther_q0225_05.htm".equalsIgnoreCase(event))
		{
			st.giveItems(LuthersLetter, 1);
			st.setCond(1);
		}
		else if("alankell_q0225_07.htm".equalsIgnoreCase(event))
		{
		...
		else if("tweety_q0225_01a.htm".equalsIgnoreCase(event))
		{
			st.takeItems(WineCatalog, -1);
			st.giveItems(TyrasContract, 1);
			st.setCond(10);
		}
		else if("bodyguard_jax_q0225_01d.htm".equalsIgnoreCase(event))
		{
			st.takeItems(OldOrder, -1);
			st.giveItems(JaxsDiary, 1);
			st.setCond(14);
		}
		else if("tree_q0225_q0225_01a.htm".equalsIgnoreCase(event))
		{
		...
		else if("strong_wooden_chest_q0225_01a.htm".equalsIgnoreCase(event))
		{
	...
	{
		if(st.getQuestItemsCount(MarkOfSearcher) != 0){ return COMPLETED_DIALOG; }
