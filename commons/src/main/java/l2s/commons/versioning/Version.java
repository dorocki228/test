...
public class Version
{
	...
	public Version(Class<?> c)
	{
		...
		{
			_log.atSevere().withStackTrace(com.google.common.flogger.StackSize.FULL).withCause(e).log( "Unable to get soft information\nFile name \'%s\' isn\'t a valid jar", (jarName == null ? "null" : jarName.getAbsolutePath()) );
		}
