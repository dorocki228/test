...
public class MultiValueSet<T> extends HashMap<T, Object>
{
	...
	public Optional<Double> getOptionalDouble(T key)
	{
		Object val = get(key);
		...
		if(val instanceof String)
			return Optional.of(Double.parseDouble((String) val));
		if(val instanceof Boolean)
	...
	public Optional<Double> getOptionalDouble(T key, double defaultValue)
	{
		Object val = get(key);
	...
	@SuppressWarnings("unchecked")
	public <E extends Enum<E>> E getEnum(T name, Class<E> enumClass, boolean toUpperCase)
	{
		Object val = get(name);
		...
		if(val != null && enumClass.isInstance(val))
			return (E) val;
		if(val instanceof String) {
			final String enumConstant = (String) val;
			return Enum.valueOf(enumClass, toUpperCase ? enumConstant.toUpperCase() : enumConstant);
		}
	...
	@SuppressWarnings("unchecked")
	public <E extends Enum<E>> E getEnum(T name, Class<E> enumClass, E defaultValue, boolean toUpperCase)
	{
		Object val = get(name);
